 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y0=we("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),fP={apiKey:"AIzaSyCJO2IQIVtUaM0NV0iltbeid8hFd6cbdnQ",authDomain:"vibetravel-39374.firebaseapp.com",projectId:"vibetravel-39374",storageBucket:"vibetravel-39374.firebasestorage.app",messagingSenderId:"408343885090",appId:"1:408343885090:web:80c286e2ef0c7832b5217b",measurementId:"G-ECPB0N84RJ"},J0=Qv(fP),ca=LA(J0),pP=RC(J0),mP=new fn,gP="my-vibe-trip-2026";class yP extends Hw.Component{constructor(e){super(e),this.state={hasError:!1,error:null}}static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,n){console.error("App Error:",e,n)}render(){var e;return this.state.hasError?R.jsxs("div",{className:"min-h-screen bg-black text-red-500 p-10 flex flex-col items-center justify-center text-center",children:[R.jsx(X0,{size:48,className:"mb-4"}),R.jsx("h1",{className:"text-2xl font-bold mb-2",children:"程式發生錯誤"}),R.jsx("p",{className:"text-gray-400 mb-4",children:"請嘗試重新整理，或檢查資料格式。"}),R.jsx("div",{className:"bg-gray-900 p-4 rounded text-left overflow-auto max-w-full mb-4",children:R.jsx("pre",{className:"text-xs",children:(e=this.state.error)==null?void 0:e.toString()})}),R.jsx("button",{onClick:()=>{localStorage.removeItem("vibetravel_last_trip_id"),window.location.href=window.location.pathname},className:"px-6 py-2 bg-red-600 text-white rounded-full hover:bg-red-500",children:"清除快取並重整"})]}):this.props.children}}const nc=()=>Math.random().toString(36).substr(2,9),vP=()=>{try{return new URLSearchParams(window.location.search).get("trip")||null}catch{return null}},_P=()=>{try{return localStorage.getItem("vibetravel_last_trip_id")}catch{return null}},Rg=t=>{try{localStorage.setItem("vibetravel_last_trip_id",t)}catch{}},_h=t=>{if(!t)return"";try{const e=new Date(t);if(isNaN(e.getTime()))return"";const r=(new Date-e)/1e3;return r<60?"剛剛":r<3600?`${Math.floor(r/60)} 分鐘前`:r<86400?`${Math.floor(r/3600)} 小時前`:`${e.getMonth()+1}/${e.getDate()} ${e.getHours().toString().padStart(2,"0")}:${e.getMinutes().toString().padStart(2,"0")}`}catch{return""}},wP=(t,e)=>{try{const n=new Date(t);return n.setDate(n.getDate()+e),n}catch{return new Date}},EP=t=>`${t.getMonth()+1}/${t.getDate()}`,rc={title:"🇻🇳 峴港·會安 6日5夜之旅",subtitle:"2026/01/02 ~ 01/07 | 家族旅行",startDate:"2026-01-02",tags:["峴港 (美溪沙灘)","會安 (古鎮)","巴拿山"],flight:{outbound:{date:"1/2",code:"UO552",route:"HKG 08:25 → DAD 09:20"},inbound:{date:"1/7",code:"UO559",route:"DAD 18:30 → HKG 21:25"}},meta:{lastEditedBy:null,lastEditedPhoto:null,lastEditedAt:null},days:[{id:"day_1",dayNum:1,highlight:"粉紅教堂＋龍橋",weather:"🌤 26°C",activities:[{id:"d1_1",time:"08:25",title:"香港起飛",subtitle:"香港快運 UO552",type:"plane",location:"香港國際機場 T1",notes:"記得提早兩小時到機場"},{id:"d1_2",time:"09:20",title:"抵達峴港 & 接機",subtitle:"預約 Grab 或 包車",type:"car",location:"峴港國際機場 T2",notes:"司機會在出口舉牌"},{id:"d1_3",time:"12:00",title:"午餐：越式米線",subtitle:"Mì Quảng 1A",type:"food",location:"Mì Quảng 1A",notes:"必點招牌米線"},{id:"d1_4",time:"14:00",title:"飯店 Check-in",subtitle:"辦理入住手續",type:"stay",location:"美溪沙灘周邊飯店",notes:""},{id:"d1_5",time:"16:30",title:"粉紅教堂打卡",subtitle:"免費參觀",type:"camera",location:"Da Nang Cathedral",notes:"穿亮色衣服拍照更好看"},{id:"d1_6",time:"19:00",title:"晚餐：越式披薩",subtitle:"Pizza 4P's",type:"food",location:"Pizza 4P's",notes:"記得先訂位"},{id:"d1_7",time:"21:00",title:"龍橋噴火秀",subtitle:"週五限定活動",type:"sightseeing",location:"Dragon Bridge",notes:"最佳觀賞點在橋頭"}]},{id:"day_2",dayNum:2,highlight:"巴拿山一日遊",weather:"🌥 22°C",activities:[{id:"d2_1",time:"08:00",title:"出發前往巴拿山",subtitle:"車程約 40 分鐘",type:"car",location:"Ba Na Hills"},{id:"d2_2",time:"09:30",title:"黃金佛手橋",subtitle:"必拍打卡點",type:"camera",location:"Golden Bridge"},{id:"d2_3",time:"12:00",title:"山頂自助午餐",subtitle:"Beer Plaza",type:"food",location:"Beer Plaza"},{id:"d2_4",time:"14:00",title:"Fantasy Park",subtitle:"室內遊樂場",type:"sightseeing",location:"室內遊樂場"},{id:"d2_5",time:"16:30",title:"搭纜車下山",subtitle:"欣賞夕陽美景",type:"transport",location:""},{id:"d2_6",time:"19:00",title:"晚餐：越南煎餅",subtitle:"Bánh Xèo Bà Dưỡng",type:"food",location:"Bánh Xèo Bà Dưỡng"}]},{id:"day_3",dayNum:3,highlight:"會安古鎮燈籠夜",weather:"☀️ 28°C",activities:[]},{id:"day_4",dayNum:4,highlight:"美溪沙灘漫步",weather:"🌤 27°C",activities:[]},{id:"day_5",dayNum:5,highlight:"山茶半島巡禮",weather:"☁️ 25°C",activities:[]},{id:"day_6",dayNum:6,highlight:"返程香港",weather:"✈️",activities:[]}]},ic=t=>kC(pP,"artifacts",gP,"public","data","trips",`trip_${t}`),TP=({isOpen:t,onClose:e,onJoin:n})=>{const[r,i]=he.useState("");return t?R.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 z-50",children:R.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-sm p-6 shadow-2xl animate-in fade-in zoom-in duration-200",children:[R.jsxs("div",{className:"flex justify-between items-center mb-4",children:[R.jsx("h3",{className:"text-lg font-bold text-white",children:"加入行程"}),R.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:R.jsx(Y0,{size:20})})]}),R.jsxs("p",{className:"text-sm text-gray-400 mb-4",children:["請輸入朋友分享的 ",R.jsx("b",{className:"text-yellow-500",children:"Trip ID"})]}),R.jsx("input",{type:"text",value:r,onChange:s=>i(s.target.value.trim()),placeholder:"例如: x9s8d7f",className:"w-full bg-[#2c2c2e] text-white rounded-xl px-4 py-3 text-lg font-mono focus:outline-none focus:ring-2 focus:ring-yellow-500 mb-4"}),R.jsx("button",{onClick:()=>{r&&n(r)},disabled:!r,className:"w-full py-3 rounded-xl bg-yellow-500 text-black font-bold hover:bg-yellow-400 disabled:opacity-50 transition-colors",children:"加入"})]})}):null},IP=({isOpen:t,onClose:e,onSave:n,onDelete:r,initialData:i,isEditMode:s})=>{const[o,l]=he.useState({time:"12:00",title:"",subtitle:"",location:"",notes:"",type:"sightseeing"});he.useEffect(()=>{t&&l(i||{time:"12:00",title:"",subtitle:"",location:"",notes:"",type:"sightseeing"})},[t,i]);const u=h=>{const{name:f,value:g}=h.target;l(y=>({...y,[f]:g}))};return t?R.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 z-50",children:R.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-md p-6 shadow-2xl animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto",children:[R.jsxs("div",{className:"flex justify-between items-center mb-6",children:[R.jsx("h3",{className:"text-lg font-bold text-white",children:s?"編輯活動":"新增活動"}),R.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:R.jsx(Y0,{size:20})})]}),R.jsxs("div",{className:"space-y-5",children:[R.jsxs("div",{children:[R.jsx("label",{className:"block text-xs text-gray-400 mb-1 font-bold",children:"活動性質"}),R.jsx("div",{className:"grid grid-cols-2 gap-2",children:R.jsxs("select",{name:"type",value:o.type,onChange:u,className:"col-span-2 w-full bg-[#2c2c2e] text-white rounded-xl px-3 py-3 text-base focus:outline-none focus:ring-2 focus:ring-yellow-500 appearance-none border-r-8 border-transparent cursor-pointer",children:[R.jsx("option",{value:"food",children:"🍽️ 美食 (餐廳/小吃)"}),R.jsx("option",{value:"sightseeing",children:"⭐️ 景點 (觀光/打卡)"}),R.jsx("option",{value:"stay",children:"🏨 住宿 (飯店/民宿)"}),R.jsx("option",{value:"transport",children:"🚗 交通 (包車/Grab)"}),R.jsx("option",{value:"event",children:"🎉 特別活動 (表演/展覽)"}),R.jsx("option",{value:"plane",children:"✈️ 飛機"}),R.jsx("option",{value:"coffee",children:"☕️ 咖啡/下午茶"})]})})]}),R.jsxs("div",{className:"flex gap-4",children:[R.jsxs("div",{className:"w-1/3",children:[R.jsx("label",{className:"block text-xs text-gray-400 mb-1 font-bold",children:"時間"}),R.jsx("input",{type:"time",name:"time",value:o.time,onChange:u,className:"w-full bg-[#2c2c2e] text-white rounded-xl px-3 py-3 text-lg font-mono focus:outline-none focus:ring-2 focus:ring-yellow-500"})]}),R.jsxs("div",{className:"flex-1",children:[R.jsx("label",{className:"block text-xs text-gray-400 mb-1 font-bold",children:"活動名稱 (必填)"}),R.jsx("input",{type:"text",name:"title",value:o.title,onChange:u,placeholder:"例如：午餐",className:"w-full bg-[#2c2c2e] text-white rounded-xl px-3 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 placeholder-gray-600"})]})]}),R.jsxs("div",{children:[R.jsx("label",{className:"block text-xs text-gray-400 mb-1 font-bold",children:"活動內容 / 詳情"}),R.jsx("input",{type:"text",name:"subtitle",value:o.subtitle,onChange:u,placeholder:"例如：越式米線、參觀教堂...",className:"w-full bg-[#2c2c2e] text-white rounded-xl px-3 py-3 text-base focus:outline-none focus:ring-2 focus:ring-yellow-500 placeholder-gray-600"})]}),R.jsxs("div",{children:[R.jsx("label",{className:"block text-xs text-gray-400 mb-1 font-bold",children:"地點 / 地址"}),R.jsxs("div",{className:"relative",children:[R.jsx("input",{type:"text",name:"location",value:o.location,onChange:u,placeholder:"輸入地點...",className:"w-full bg-[#2c2c2e] text-white rounded-xl px-3 py-3 pl-10 text-base focus:outline-none focus:ring-2 focus:ring-yellow-500 placeholder-gray-600"}),R.jsx(Da,{size:18,className:"absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"})]})]}),R.jsxs("div",{children:[R.jsx("label",{className:"block text-xs text-gray-400 mb-1 font-bold",children:"備註"}),R.jsx("textarea",{name:"notes",value:o.notes,onChange:u,placeholder:"例如：記得訂位、門票費用...",rows:"3",className:"w-full bg-[#2c2c2e] text-white rounded-xl px-3 py-3 text-base focus:outline-none focus:ring-2 focus:ring-yellow-500 resize-none placeholder-gray-600"})]}),(i==null?void 0:i.meta)&&R.jsxs("div",{className:"mt-6 pt-4 border-t border-gray-700/50 text-[10px] text-gray-500 space-y-1",children:[i.meta.createdBy&&R.jsxs("p",{children:["建立者: ",R.jsx("span",{className:"text-gray-400",children:i.meta.createdBy})," (",_h(i.meta.createdAt),")"]}),i.meta.lastEditedBy&&R.jsxs("p",{children:["最後編輯: ",R.jsx("span",{className:"text-yellow-500",children:i.meta.lastEditedBy})," (",_h(i.meta.lastEditedAt),")"]})]})]}),R.jsxs("div",{className:"flex gap-3 mt-6 pt-2",children:[s&&R.jsx("button",{onClick:()=>{window.confirm("確定要刪除此活動嗎？")&&r()},className:"px-4 py-3 rounded-xl border border-red-900/50 text-red-500 font-medium hover:bg-red-900/20 transition-colors",children:R.jsx(hP,{size:20})}),R.jsx("button",{onClick:()=>{o.title&&n(o)},disabled:!o.title,className:"flex-1 py-3 rounded-xl bg-yellow-500 text-black font-bold hover:bg-yellow-400 disabled:opacity-50 transition-colors shadow-lg shadow-yellow-500/20",children:s?"儲存修改":"確認新增"})]})]})}):null};function SP(){var Pt;const[t,e]=he.useState(null),[n,r]=he.useState(null),[i,s]=he.useState(!0),[o,l]=he.useState(null),[u,h]=he.useState(rc),[f,g]=he.useState("day_1"),[y,k]=he.useState(!1),[x,D]=he.useState(""),[O,I]=he.useState(!1),[w,S]=he.useState(!1),[V,U]=he.useState({isOpen:!1,mode:"add",initialData:null,activityId:null}),[F,v]=he.useState("idle"),[m,_]=he.useState(!1);he.useEffect(()=>{_(window.location.protocol==="blob:"||window.location.protocol==="file:")},[]),he.useEffect(()=>{const z=SS(ca,X=>{X?(e(X),s(!1)):vS(ca).catch(ge=>{console.error("Auto guest login failed",ge),s(!1)})});return()=>z()},[]);const T=async()=>{try{await WS(ca,mP)}catch(z){console.error("Login failed",z),l("登入失敗，請確認您已在 Firebase 開啟 Google Auth")}},A=async()=>{await AS(ca)},C=async(z,X=!1)=>{s(!0),r(z),l(null),Rg(z);const ge=`?trip=${z}`;try{window.history.pushState({path:ge},"",ge)}catch{}if(X){const fe=ic(z);try{const ie={...rc,meta:{lastEditedBy:(t==null?void 0:t.displayName)||"匿名用戶",lastEditedPhoto:t==null?void 0:t.photoURL,lastEditedAt:new Date().toISOString()}};await Tg(fe,ie),h(ie),g(rc.days[0].id)}catch(ie){console.error("Create trip failed",ie),l("建立失敗：請檢查資料庫權限")}s(!1)}};he.useEffect(()=>{if(!t)return;let z=n;if(!z){const fe=vP(),ie=_P();if(fe)z=fe,r(fe),Rg(fe);else if(ie){z=ie,r(ie);const pt=`?trip=${ie}`;try{window.history.pushState({path:pt},"",pt)}catch{}}else{const pt=nc();C(pt,!0);return}}const X=ic(z),ge=$C(X,fe=>{if(fe.exists()){const ie=fe.data();if(h(pt=>({...pt,...ie})),ie.days&&ie.days.length>0){const pt=ie.days.some(Hr=>Hr.id===f);(!f||!pt)&&g(ie.days[0].id)}v("saved")}s(!1)},fe=>{console.error("Snapshot error:",fe),l("讀取錯誤，請稍後再試"),s(!1),v("error")});return()=>ge()},[t,n]);const E=async z=>{if(t!=null&&t.isAnonymous){v("error"),D("訪客無法儲存，請先登入"),k(!0),setTimeout(()=>k(!1),3e3);return}const X={...z,meta:{lastEditedBy:t.displayName||"使用者",lastEditedPhoto:t.photoURL,lastEditedAt:new Date().toISOString()}};if(h(X),v("saving"),!n||!t){v("error");return}try{await Tg(ic(n),X),v("saved"),o&&l(null)}catch(ge){console.error("Save error:",ge),v("error")}},at=(z,X,ge)=>{const fe=u.days.map(ie=>ie.id!==z?ie:{...ie,[X]:ge});E({...u,days:fe})},ln=()=>{U({isOpen:!0,mode:"add",initialData:null,activityId:null})},fr=z=>{t!=null&&t.isAnonymous||U({isOpen:!0,mode:"edit",initialData:z,activityId:z.id})},wt=()=>{U({...V,isOpen:!1})},B=z=>{const X=u.days.map(ge=>{if(ge.id!==f)return ge;let fe;if(V.mode==="add"){const ie={id:nc(),...z,meta:{createdBy:t.displayName||"匿名",createdAt:new Date().toISOString(),lastEditedBy:t.displayName||"匿名",lastEditedAt:new Date().toISOString(),lastEditedPhoto:t.photoURL}};fe=[...ge.activities,ie]}else fe=ge.activities.map(ie=>ie.id===V.activityId?{...ie,...z,meta:{...ie.meta,lastEditedBy:t.displayName||"匿名",lastEditedAt:new Date().toISOString(),lastEditedPhoto:t.photoURL}}:ie);return fe.sort((ie,pt)=>ie.time.localeCompare(pt.time)),{...ge,activities:fe}});E({...u,days:X}),wt()},K=()=>{if(V.mode==="edit"){const z=u.days.map(X=>X.id!==f?X:{...X,activities:X.activities.filter(ge=>ge.id!==V.activityId)});E({...u,days:z}),wt()}},Z=()=>{const z=u.days.length+1,X={id:nc(),dayNum:z,highlight:"新行程",weather:"🌤",activities:[]};E({...u,days:[...u.days,X]}),g(X.id)},me=()=>{if(u.days.length<=1||!window.confirm("確定要刪除最後一天的行程嗎？"))return;const z=[...u.days];z.pop();let X=f;f===u.days[u.days.length-1].id&&(X=z[z.length-1].id),E({...u,days:z}),g(X)},le=()=>{let z=m?n:`${window.location.origin}${window.location.pathname}?trip=${n}`;navigator.clipboard.writeText(z),D("已複製連結"),k(!0),setTimeout(()=>k(!1),3e3)},Te=z=>{const X={size:16,strokeWidth:2.5};switch(z){case"food":return R.jsx(dP,{...X,className:"text-orange-500"});case"transport":return R.jsx(ZC,{...X,className:"text-blue-400"});case"plane":return R.jsx(lP,{...X,className:"text-blue-400"});case"car":return R.jsx(YC,{...X,className:"text-blue-400"});case"stay":return R.jsx(QC,{...X,className:"text-indigo-400"});case"camera":return R.jsx(XC,{...X,className:"text-green-500"});case"coffee":return R.jsx(rP,{...X,className:"text-amber-500"});case"sightseeing":return R.jsx(cP,{...X,className:"text-yellow-500"});case"event":return R.jsx(aP,{...X,className:"text-pink-500"});case"boat":return R.jsx(Da,{...X,className:"text-teal-400"});default:return R.jsx(Da,{...X,className:"text-gray-400"})}},Ft=z=>{switch(z){case"food":return"bg-orange-500/10 border-orange-500/30";case"plane":case"car":case"transport":return"bg-blue-500/10 border-blue-500/30";case"stay":return"bg-indigo-500/10 border-indigo-500/30";case"camera":return"bg-green-500/10 border-green-500/30";case"coffee":return"bg-amber-500/10 border-amber-500/30";case"sightseeing":return"bg-yellow-500/10 border-yellow-500/30";case"event":return"bg-pink-500/10 border-pink-500/30";default:return"bg-gray-700/30 border-gray-600"}};if(i)return R.jsx("div",{className:"flex h-screen items-center justify-center bg-[#101010] text-yellow-500",children:R.jsx(Ag,{size:32,className:"animate-spin"})});if(!t)return R.jsx("div",{className:"flex h-screen items-center justify-center bg-[#101010]"});const Fe=(u.days||[]).find(z=>z.id===f)||(u.days||[])[0];return R.jsxs("div",{className:"min-h-screen bg-[#101010] text-gray-200 font-sans pb-20 selection:bg-yellow-500/30",children:[R.jsx(TP,{isOpen:O,onClose:()=>I(!1),onJoin:z=>{I(!1),C(z,!1)}}),R.jsx(IP,{isOpen:V.isOpen,onClose:wt,onSave:B,onDelete:K,initialData:V.initialData,isEditMode:V.mode==="edit"}),R.jsxs("div",{className:"bg-gray-900 px-4 py-2 flex justify-between items-center border-b border-gray-800",children:[R.jsx("div",{className:"flex items-center gap-2 text-xs text-gray-400",children:(Pt=u.meta)!=null&&Pt.lastEditedBy?R.jsxs(R.Fragment,{children:[R.jsx("span",{children:"最後修改:"}),u.meta.lastEditedPhoto?R.jsx("img",{src:u.meta.lastEditedPhoto,className:"w-4 h-4 rounded-full",alt:""}):R.jsx(kg,{size:14}),R.jsx("span",{className:"text-yellow-500",children:u.meta.lastEditedBy}),R.jsxs("span",{children:["• ",_h(u.meta.lastEditedAt)]})]}):R.jsx("span",{children:"新行程"})}),R.jsx("div",{className:"flex items-center gap-3",children:t!=null&&t.isAnonymous?R.jsxs("button",{onClick:T,className:"flex items-center gap-2 bg-yellow-500 text-black px-3 py-1.5 rounded-full text-xs font-bold hover:bg-yellow-400 transition-colors shadow-[0_0_10px_rgba(234,179,8,0.3)] animate-pulse",children:[R.jsx(Ig,{size:14}),"登入 Google 以編輯"]}):R.jsxs(R.Fragment,{children:[R.jsxs("div",{className:"flex items-center gap-2 bg-gray-800 rounded-full px-2 py-1 pr-3",children:[t.photoURL?R.jsx("img",{src:t.photoURL,alt:t.displayName,className:"w-5 h-5 rounded-full"}):R.jsx(kg,{size:16,className:"text-gray-400"}),R.jsx("span",{className:"text-xs font-bold text-gray-300",children:t.displayName})]}),R.jsx("button",{onClick:A,title:"登出",className:"text-gray-500 hover:text-white",children:R.jsx(sP,{size:16})})]})})]}),R.jsxs("div",{className:"relative bg-[#101010]",children:[R.jsxs("div",{className:"absolute inset-0 z-0",children:[R.jsx("img",{src:"https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?q=80&w=2000&auto=format&fit=crop",alt:"Da Nang",className:"w-full h-full object-cover opacity-40"}),R.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-[#101010]/20 via-[#101010]/90 to-[#101010]"})]}),R.jsx("div",{className:"relative z-10 px-5 pt-10 pb-2",children:R.jsxs("div",{className:"max-w-md mx-auto",children:[R.jsxs("div",{className:"flex justify-between items-start mb-2",children:[R.jsxs("div",{children:[R.jsx("input",{className:"text-2xl font-bold text-yellow-500 w-full bg-transparent outline-none placeholder-yellow-800 disabled:opacity-80 disabled:cursor-not-allowed drop-shadow-lg",value:u.title,onChange:z=>E({...u,title:z.target.value}),disabled:t==null?void 0:t.isAnonymous}),R.jsx("input",{className:"text-xs text-gray-300 mt-1 w-full bg-transparent outline-none disabled:opacity-80 disabled:cursor-not-allowed drop-shadow-md",value:u.subtitle||"",placeholder:"日期 | 天數 | 旅行人數",onChange:z=>E({...u,subtitle:z.target.value}),disabled:t==null?void 0:t.isAnonymous})]}),R.jsxs("div",{className:"flex gap-3",children:[R.jsx("button",{onClick:()=>I(!0),title:"加入行程",children:R.jsx(Ig,{size:20,className:"text-gray-300 hover:text-white drop-shadow-md"})}),R.jsx("button",{onClick:le,title:"複製連結",children:R.jsx(uP,{size:20,className:"text-yellow-500 hover:text-yellow-400 drop-shadow-md"})})]})]}),R.jsxs("div",{className:"absolute top-4 right-4 flex items-center gap-1 text-xs",children:[F==="saving"&&R.jsxs("span",{className:"text-yellow-500 flex items-center animate-pulse",children:[R.jsx(Ag,{size:12,className:"mr-1"})," 儲存中..."]}),F==="saved"&&R.jsxs("span",{className:"text-green-500 flex items-center",children:[R.jsx(nP,{size:12,className:"mr-1"})," 已同步"]}),F==="error"&&R.jsxs("span",{className:"text-red-500 flex items-center",children:[R.jsx(tP,{size:12,className:"mr-1"})," ",t!=null&&t.isAnonymous?"訪客模式":"未同步"]})]}),R.jsxs("div",{className:"bg-[#1c1c1e]/80 backdrop-blur-sm rounded-xl p-4 mb-4 border border-gray-700 flex items-center relative overflow-hidden group shadow-lg",children:[R.jsx("div",{className:"absolute left-0 top-0 bottom-0 w-1 bg-yellow-500"}),R.jsxs("div",{className:"flex-1 flex items-center justify-between pl-3",children:[R.jsxs("div",{children:[R.jsx("div",{className:"text-xs text-gray-400 mb-1",children:"當日重點行程"}),R.jsx("input",{className:"text-lg font-bold text-white bg-transparent outline-none placeholder-gray-600 w-full",value:Fe.highlight||"",placeholder:"輸入重點 (8字內)",maxLength:8,onChange:z=>at(f,"highlight",z.target.value),disabled:t==null?void 0:t.isAnonymous})]}),R.jsxs("div",{className:"text-right border-l border-gray-600 pl-4 ml-4",children:[R.jsx("div",{className:"text-xs text-gray-400 mb-1",children:"天氣"}),R.jsx("input",{className:"text-lg font-bold text-yellow-400 bg-transparent outline-none placeholder-gray-600 w-20 text-right",value:Fe.weather||"",placeholder:"🌤 28°C",onChange:z=>at(f,"weather",z.target.value),disabled:t==null?void 0:t.isAnonymous})]})]})]}),R.jsxs("div",{className:"flex items-center overflow-x-auto no-scrollbar border-b border-gray-800",children:[R.jsx("div",{className:"flex",children:(u.days||[]).map((z,X)=>{const ge=Fe&&Fe.id===z.id,fe=wP(u.startDate,X);return R.jsxs("button",{onClick:()=>g(z.id),className:`flex-shrink-0 px-4 py-3 flex flex-col items-center justify-center transition-all border-b-2 relative ${ge?"text-yellow-500 border-yellow-500":"text-gray-500 border-transparent hover:text-gray-300"}`,children:[R.jsx("span",{className:`text-sm font-bold ${ge?"text-yellow-400":"text-gray-400"}`,children:EP(fe)}),R.jsxs("span",{className:"text-[10px] opacity-60 uppercase tracking-wide",children:["Day ",X+1]})]},z.id)})}),!(t!=null&&t.isAnonymous)&&R.jsxs("div",{className:"flex items-center pl-2 border-l border-gray-800 ml-2",children:[R.jsx("button",{onClick:Z,className:"px-3 py-2 text-gray-500 hover:text-yellow-500",children:R.jsx(Sg,{size:18})}),R.jsx("button",{onClick:me,className:"px-3 py-2 text-gray-600 hover:text-red-500",children:R.jsx(oP,{size:18})})]})]})]})})]}),o&&R.jsxs("div",{className:"bg-red-900/90 text-white px-4 py-3 text-sm flex items-center justify-center gap-2 border-b border-red-500 sticky top-0 z-50 animate-pulse",children:[R.jsx(X0,{size:16,className:"text-yellow-300"}),R.jsx("span",{children:o})]}),R.jsx("div",{className:"max-w-md mx-auto px-5 py-4",children:R.jsxs("div",{className:"space-y-0 relative",children:[R.jsxs("div",{className:"flex items-center gap-2 mb-4 text-gray-400 text-sm",children:[R.jsx(eP,{size:16})," ",R.jsx("span",{children:"每日行程時間軸"})]}),Fe&&(Fe.activities||[]).map((z,X)=>R.jsxs("div",{onClick:()=>fr(z),className:`relative pl-0 group flex ${t!=null&&t.isAnonymous?"":"cursor-pointer hover:bg-white/5 rounded-lg transition-colors"}`,children:[R.jsx("div",{className:"w-20 pt-1 pr-2 flex-shrink-0 text-right",children:R.jsx("div",{className:"text-sm font-bold text-gray-300 font-mono",children:z.time})}),R.jsxs("div",{className:"relative flex flex-col items-center mr-4",children:[R.jsx("div",{className:`absolute w-[2px] bg-[#333] ${X===0?"top-3 h-[calc(100%-12px)]":"h-full"} ${X===Fe.activities.length-1?"h-4":""}`}),R.jsx("div",{className:`relative z-10 w-8 h-8 rounded-full border-2 flex items-center justify-center transition-transform group-hover:scale-110 ${Ft(z.type)}`,children:Te(z.type)})]}),R.jsx("div",{className:"flex-1 pb-8 min-w-0 pt-1",children:R.jsxs("div",{children:[R.jsx("div",{className:"text-base font-bold text-gray-200",children:z.title}),R.jsxs("div",{className:"flex flex-col mt-1 gap-1",children:[z.subtitle&&R.jsx("div",{className:"text-sm text-gray-400",children:z.subtitle}),z.location&&R.jsxs("div",{className:"flex items-center gap-1 text-xs text-gray-500",children:[R.jsx(Da,{size:12}),R.jsx("a",{href:`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(z.location)}`,target:"_blank",rel:"noopener noreferrer",onClick:ge=>ge.stopPropagation(),className:"hover:text-yellow-500 underline decoration-dotted",children:z.location})]}),z.notes&&R.jsxs("div",{className:"flex items-start gap-1 mt-1 bg-gray-800/50 p-2 rounded-lg border border-gray-700/50",children:[R.jsx(iP,{size:12,className:"text-gray-500 mt-0.5 flex-shrink-0"}),R.jsx("div",{className:"text-xs text-gray-400 leading-relaxed whitespace-pre-wrap",children:z.notes})]})]})]})})]},z.id)),Fe&&R.jsxs("div",{className:"pl-14 flex items-center gap-4",children:[R.jsx("div",{className:"w-8 flex justify-center",children:R.jsx("div",{className:"w-[2px] h-4 bg-[#333]"})}),!(t!=null&&t.isAnonymous)&&R.jsxs("button",{onClick:ln,className:"flex items-center gap-2 text-gray-500 hover:text-yellow-500 text-sm py-2",children:[R.jsx("div",{className:"w-6 h-6 rounded-full border border-dashed border-gray-600 flex items-center justify-center",children:R.jsx(Sg,{size:14})}),"新增行程"]})]})]})}),R.jsxs("div",{className:`fixed bottom-6 left-1/2 -translate-x-1/2 bg-yellow-500 text-black px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2 transition-all ${y?"opacity-100 translate-y-0":"opacity-0 translate-y-4 pointer-events-none"}`,children:[R.jsx(JC,{size:16})," ",x]})]})}function AP(){return R.jsx(yP,{children:R.jsx(SP,{})})}jv(document.getElementById("root")).render(R.jsx(he.StrictMode,{children:R.jsx(AP,{})}));
