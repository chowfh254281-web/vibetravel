 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sm(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(u_(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(o_(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(h_(e))return"Blackberry";if(d_(e))return"Webos";if(a_(e))return"Safari";if((e.includes("chrome/")||l_(e))&&!e.includes("edge/"))return"Chrome";if(c_(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function o_(t=ot()){return/firefox\//i.test(t)}function a_(t=ot()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function l_(t=ot()){return/crios\//i.test(t)}function u_(t=ot()){return/iemobile/i.test(t)}function c_(t=ot()){return/android/i.test(t)}function h_(t=ot()){return/blackberry/i.test(t)}function d_(t=ot()){return/webos/i.test(t)}function wd(t=ot()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function X1(t=ot()){var e;return wd(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Y1(){return dI()&&document.documentMode===10}function f_(t=ot()){return wd(t)||c_(t)||d_(t)||h_(t)||/windows phone/i.test(t)||u_(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function p_(t,e=[]){let n;switch(t){case"Browser":n=Sm(ot());break;case"Worker":n=`${Sm(ot())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Fi}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt{constructor(e){this.fields=e,e.sort(We.comparator)}static empty(){return new jt([])}unionWith(e){let n=new Ke(We.comparator);for(const r of this.fields)n=n.add(r);for(const r of e)n=n.add(r);return new jt(n.toArray())}covers(e){for(const n of this.fields)if(n.isPrefixOf(e))return!0;return!1}isEqual(e){return Pi(this.fields,e.fields,(n,r)=>n.isEqual(r))}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new F_("Invalid base64 string: "+s):s}}(e);return new Qe(n)}static fromUint8Array(e){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new Qe(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return ue(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Qe.EMPTY_BYTE_STRING=new Qe("");const GA=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function ir(t){if(fe(!!t),typeof t=="string"){let e=0;const n=GA.exec(t);if(fe(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Pe(t.seconds),nanos:Pe(t.nanos)}}function Pe(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Mr(t){return typeof t=="string"?Qe.fromBase64String(t):Qe.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct{constructor(e){this.value=e}static empty(){return new Ct({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let r=0;r<e.length-1;++r)if(n=(n.mapValue.fields||{})[e.get(r)],!Sa(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=xs(n)}setAll(e){let n=We.emptyPath(),r={},i=[];e.forEach((o,l)=>{if(!n.isImmediateParentOf(l)){const u=this.getFieldsMap(n);this.applyChanges(u,r,i),r={},i=[],n=l.popLast()}o?r[l.lastSegment()]=xs(o):i.push(l.lastSegment())});const s=this.getFieldsMap(n);this.applyChanges(s,r,i)}delete(e){const n=this.field(e.popLast());Sa(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return tn(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let r=0;r<e.length;++r){let i=n.mapValue.fields[e.get(r)];Sa(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},n.mapValue.fields[e.get(r)]=i),n=i}return n.mapValue.fields}applyChanges(e,n,r){zi(n,(i,s)=>e[i]=s);for(const i of r)delete e[i]}clone(){return new Ct(xs(this.value))}}function U_(t){const e=[];return zi(t.fields,(n,r)=>{const i=new We([n]);if(Sa(r)){const s=U_(r.mapValue).fields;if(s.length===0)e.push(i);else for(const o of s)e.push(i.child(o))}else e.push(i)}),new jt(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j_{}class Oe extends j_{constructor(e,n,r){super(),this.field=e,this.op=n,this.value=r}static create(e,n,r){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,r):new ek(e,n,r):n==="array-contains"?new rk(e,r):n==="in"?new ik(e,r):n==="not-in"?new sk(e,r):n==="array-contains-any"?new ok(e,r):new Oe(e,n,r)}static createKeyFieldInFilter(e,n,r){return n==="in"?new tk(e,r):new nk(e,r)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&this.matchesComparison(xi(n,this.value)):n!==null&&Lr(this.value)===Lr(n)&&this.matchesComparison(xi(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return Q()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class nn extends j_{constructor(e,n){super(),this.filters=e,this.op=n,this.ae=null}static create(e,n){return new nn(e,n)}matches(e){return z_(this)?this.filters.find(n=>!n.matches(e))===void 0:this.filters.find(n=>n.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,n)=>e.concat(n.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function z_(t){return t.op==="and"}function B_(t){return ZA(t)&&z_(t)}function ZA(t){for(const e of t.filters)if(e instanceof nn)return!1;return!0}function oh(t){if(t instanceof Oe)return t.field.canonicalString()+t.op.toString()+Ni(t.value);if(B_(t))return t.filters.map(e=>oh(e)).join(",");{const e=t.filters.map(n=>oh(n)).join(",");return`${t.op}(${e})`}}function $_(t,e){return t instanceof Oe?function(r,i){return i instanceof Oe&&r.op===i.op&&r.field.isEqual(i.field)&&tn(r.value,i.value)}(t,e):t instanceof nn?function(r,i){return i instanceof nn&&r.op===i.op&&r.filters.length===i.filters.length?r.filters.reduce((s,o,l)=>s&&$_(o,i.filters[l]),!0):!1}(t,e):void Q()}function H_(t){return t instanceof Oe?function(n){return`${n.field.canonicalString()} ${n.op} ${Ni(n.value)}`}(t):t instanceof nn?function(n){return n.op.toString()+" {"+n.getFilters().map(H_).join(" ,")+"}"}(t):"Filter"}class ek extends Oe{constructor(e,n,r){super(e,n,r),this.key=q.fromName(r.referenceValue)}matches(e){const n=q.comparator(e.key,this.key);return this.matchesComparison(n)}}class tk extends Oe{constructor(e,n){super(e,"in",n),this.keys=W_("in",n)}matches(e){return this.keys.some(n=>n.isEqual(e.key))}}class nk extends Oe{constructor(e,n){super(e,"not-in",n),this.keys=W_("not-in",n)}matches(e){return!this.keys.some(n=>n.isEqual(e.key))}}function W_(t,e){var n;return(((n=e.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(r=>q.fromName(r.referenceValue))}class rk extends Oe{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return Pd(n)&&no(n.arrayValue,this.value)}}class ik extends Oe{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&no(this.value.arrayValue,n)}}class sk extends Oe{constructor(e,n){super(e,"not-in",n)}matches(e){if(no(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&!no(this.value.arrayValue,n)}}class ok extends Oe{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!Pd(n)||!n.arrayValue.values)&&n.arrayValue.values.some(r=>no(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fk=new Ae(q.comparator);function kn(){return fk}const G_=new Ae(q.comparator);function ys(...t){let e=G_;for(const n of t)e=e.insert(n.key,n);return e}function Q_(t){let e=G_;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Er(){return Ds()}function X_(){return Ds()}function Ds(){return new Bi(t=>t.toString(),(t,e)=>t.isEqual(e))}const pk=new Ae(q.comparator),mk=new Ke(q.comparator);function ne(...t){let e=mk;for(const n of t)e=e.add(n);return e}const gk=new Ke(ue);function yk(){return gk}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eR{constructor(){this.changes=new Bi(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,it.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?M.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sR{constructor(){this.sessionToken=Qe.EMPTY_BYTE_STRING}getSessionToken(e){return M.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,M.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bd{constructor(){this.Tr=new Ke(Fe.Er),this.dr=new Ke(Fe.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,n){const r=new Fe(e,n);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Vr(new Fe(e,n))}mr(e,n){e.forEach(r=>this.removeReference(r,n))}gr(e){const n=new q(new Ce([])),r=new Fe(n,e),i=new Fe(n,e+1),s=[];return this.dr.forEachInRange([r,i],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const n=new q(new Ce([])),r=new Fe(n,e),i=new Fe(n,e+1);let s=ne();return this.dr.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const n=new Fe(e,0),r=this.Tr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class Fe{constructor(e,n){this.key=e,this.wr=n}static Er(e,n){return q.comparator(e.key,n.key)||ue(e.wr,n.wr)}static Ar(e,n){return ue(e.wr,n.wr)||q.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oR{constructor(e,n){this.indexManager=e,this.referenceDelegate=n,this.mutationQueue=[],this.Sr=1,this.br=new Ke(Fe.Er)}checkEmpty(e){return M.resolve(this.mutationQueue.length===0)}addMutationBatch(e,n,r,i){const s=this.Sr;this.Sr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new kk(s,n,r,i);this.mutationQueue.push(o);for(const l of i)this.br=this.br.add(new Fe(l.key,s)),this.indexManager.addToCollectionParentIndex(e,l.key.path.popLast());return M.resolve(o)}lookupMutationBatch(e,n){return M.resolve(this.Dr(n))}getNextMutationBatchAfterBatchId(e,n){const r=n+1,i=this.vr(r),s=i<0?0:i;return M.resolve(this.mutationQueue.length>s?this.mutationQueue[s]:null)}getHighestUnacknowledgedBatchId(){return M.resolve(this.mutationQueue.length===0?-1:this.Sr-1)}getAllMutationBatches(e){return M.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,n){const r=new Fe(n,0),i=new Fe(n,Number.POSITIVE_INFINITY),s=[];return this.br.forEachInRange([r,i],o=>{const l=this.Dr(o.wr);s.push(l)}),M.resolve(s)}getAllMutationBatchesAffectingDocumentKeys(e,n){let r=new Ke(ue);return n.forEach(i=>{const s=new Fe(i,0),o=new Fe(i,Number.POSITIVE_INFINITY);this.br.forEachInRange([s,o],l=>{r=r.add(l.wr)})}),M.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,n){const r=n.path,i=r.length+1;let s=r;q.isDocumentKey(s)||(s=s.child(""));const o=new Fe(new q(s),0);let l=new Ke(ue);return this.br.forEachWhile(u=>{const h=u.key.path;return!!r.isPrefixOf(h)&&(h.length===i&&(l=l.add(u.wr)),!0)},o),M.resolve(this.Cr(l))}Cr(e){const n=[];return e.forEach(r=>{const i=this.Dr(r);i!==null&&n.push(i)}),n}removeMutationBatch(e,n){fe(this.Fr(n.batchId,"removed")===0),this.mutationQueue.shift();let r=this.br;return M.forEach(n.mutations,i=>{const s=new Fe(i.key,n.batchId);return r=r.delete(s),this.referenceDelegate.markPotentiallyOrphaned(e,i.key)}).next(()=>{this.br=r})}On(e){}containsKey(e,n){const r=new Fe(n,0),i=this.br.firstAfterOrEqual(r);return M.resolve(n.isEqual(i&&i.key))}performConsistencyCheck(e){return this.mutationQueue.length,M.resolve()}Fr(e,n){return this.vr(e)}vr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Dr(e){const n=this.vr(e);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fR{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return fI()?8:qA(ot())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Yi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Zi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new dR;return this.Xi(e,n,o).next(l=>{if(s.result=l,this.zi)return this.es(e,n,o,l.size)})}).next(()=>s.result)}es(e,n,r,i){return r.documentReadCount<this.ji?(hs()<=ie.DEBUG&&H("QueryEngine","SDK will not create cache indexes for query:",Kr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),M.resolve()):(hs()<=ie.DEBUG&&H("QueryEngine","Query:",Kr(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(hs()<=ie.DEBUG&&H("QueryEngine","The SDK decides to create cache indexes for query:",Kr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Jt(n))):M.resolve())}Yi(e,n){if(Gm(n))return M.resolve(null);let r=Jt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=lh(n,null,"F"),r=Jt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=ne(...s);return this.Ji.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.ts(n,l);return this.ns(n,h,o,u.readTime)?this.Yi(e,lh(n,null,"F")):this.rs(e,h,n,u)}))})))}Zi(e,n,r,i){return Gm(n)||i.isEqual(Y.min())?M.resolve(null):this.Ji.getDocuments(e,r).next(s=>{const o=this.ts(n,s);return this.ns(n,o,r,i)?M.resolve(null):(hs()<=ie.DEBUG&&H("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Kr(n)),this.rs(e,o,n,zA(i,-1)).next(l=>l))})}ts(e,n){let r=new Ke(K_(e));return n.forEach((i,s)=>{Ul(e,s)&&(r=r.add(s))}),r}ns(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,n,r){return hs()<=ie.DEBUG&&H("QueryEngine","Using full collection scan to execute query:",Kr(n)),this.Ji.getDocumentsMatchingQuery(e,n,rr.min(),r)}rs(e,n,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi{constructor(e){this.comparator=e?(n,r)=>e(n,r)||q.comparator(n.key,r.key):(n,r)=>q.comparator(n.key,r.key),this.keyedMap=ys(),this.sortedSet=new Ae(this.comparator)}static emptySet(e){return new yi(e.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,r)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof yi)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),r=e.sortedSet.getIterator();for(;n.hasNext();){const i=n.getNext().key,s=r.getNext().key;if(!i.isEqual(s))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oi{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Oi(Qe.fromBase64String(e))}catch(n){throw new W(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new Oi(Qe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xd{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new W(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new We(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DC(t){if(t.limitType==="L"&&t.explicitOrderBy.length===0)throw new W(L.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class VC{convertValue(e,n="none"){switch(Lr(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Pe(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,n);case 5:return e.stringValue;case 6:return this.convertBytes(Mr(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,n);case 11:return this.convertObject(e.mapValue,n);case 10:return this.convertVectorValue(e.mapValue);default:throw Q()}}convertObject(e,n){return this.convertObjectMap(e.fields,n)}convertObjectMap(e,n="none"){const r={};return zi(e,(i,s)=>{r[i]=this.convertValue(s,n)}),r}convertVectorValue(e){var n,r,i;const s=(i=(r=(n=e.fields)===null||n===void 0?void 0:n.value.arrayValue)===null||r===void 0?void 0:r.values)===null||i===void 0?void 0:i.map(o=>Pe(o.doubleValue));return new Jd(s)}convertGeoPoint(e){return new Yd(Pe(e.latitude),Pe(e.longitude))}convertArray(e,n){return(e.values||[]).map(r=>this.convertValue(r,n))}convertServerTimestamp(e,n){switch(n){case"previous":const r=Cd(e);return r==null?null:this.convertValue(r,n);case"estimate":return this.convertTimestamp(eo(e));default:return null}}convertTimestamp(e){const n=ir(e);return new Le(n.seconds,n.nanos)}convertDocumentKey(e,n){const r=Ce.fromString(e);fe(p0(r));const i=new to(r.get(1),r.get(3)),s=new q(r.popFirst(5));return i.isEqual(n)||An(`Document ${s} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ee=(t,e)=>{const n=me.forwardRef(({className:r,...i},s)=>me.createElement(BC,{ref:s,iconNode:e,className:K0(`lucide-${jC(t)}`,r),...i}));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $C=Ee("Bed",[["path",{d:"M2 4v16",key:"vw9hq8"}],["path",{d:"M2 8h18a2 2 0 0 1 2 2v10",key:"1dgv2r"}],["path",{d:"M2 17h20",key:"18nfp3"}],["path",{d:"M6 8v9",key:"1yriud"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const HC=Ee("Camera",[["path",{d:"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z",key:"1tc9qg"}],["circle",{cx:"12",cy:"13",r:"3",key:"1vg3eu"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const WC=Ee("Car",[["path",{d:"M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2",key:"5owen"}],["circle",{cx:"7",cy:"17",r:"2",key:"u2ysq9"}],["path",{d:"M9 17h6",key:"r8uit2"}],["circle",{cx:"17",cy:"17",r:"2",key:"axvx0g"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qC=Ee("Check",[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const GC=Ee("Clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const QC=Ee("CloudOff",[["path",{d:"m2 2 20 20",key:"1ooewy"}],["path",{d:"M5.782 5.782A7 7 0 0 0 9 19h8.5a4.5 4.5 0 0 0 1.307-.193",key:"yfwify"}],["path",{d:"M21.532 16.5A4.5 4.5 0 0 0 17.5 10h-1.79A7.008 7.008 0 0 0 10 5.07",key:"jlfiyv"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const XC=Ee("Cloud",[["path",{d:"M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z",key:"p7xjir"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const YC=Ee("Coffee",[["path",{d:"M10 2v2",key:"7u0qdc"}],["path",{d:"M14 2v2",key:"6buw04"}],["path",{d:"M16 8a1 1 0 0 1 1 1v8a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4V9a1 1 0 0 1 1-1h14a4 4 0 1 1 0 8h-1",key:"pwadti"}],["path",{d:"M6 2v2",key:"colzsn"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const JC=Ee("LogIn",[["path",{d:"M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4",key:"u53s6r"}],["polyline",{points:"10 17 15 12 10 7",key:"1ail0h"}],["line",{x1:"15",x2:"3",y1:"12",y2:"12",key:"v6grx8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ZC=Ee("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tg=Ee("MapPin",[["path",{d:"M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z",key:"2oe9fu"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const eP=Ee("Map",[["path",{d:"M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z",key:"169xi5"}],["path",{d:"M15 5.764v15",key:"1pn4in"}],["path",{d:"M9 3.236v15",key:"1uimfh"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tP=Ee("Plane",[["path",{d:"M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z",key:"1v9wt8"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ig=Ee("Plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const nP=Ee("QrCode",[["rect",{width:"5",height:"5",x:"3",y:"3",rx:"1",key:"1tu5fj"}],["rect",{width:"5",height:"5",x:"16",y:"3",rx:"1",key:"1v8r4q"}],["rect",{width:"5",height:"5",x:"3",y:"16",rx:"1",key:"1x03jg"}],["path",{d:"M21 16h-3a2 2 0 0 0-2 2v3",key:"177gqh"}],["path",{d:"M21 21v.01",key:"ents32"}],["path",{d:"M12 7v3a2 2 0 0 1-2 2H7",key:"8crl2c"}],["path",{d:"M3 12h.01",key:"nlz23k"}],["path",{d:"M12 3h.01",key:"n36tog"}],["path",{d:"M12 16v.01",key:"133mhm"}],["path",{d:"M16 12h1",key:"1slzba"}],["path",{d:"M21 12v.01",key:"1lwtk9"}],["path",{d:"M12 21v-1",key:"1880an"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Sg=Ee("RefreshCw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const G0=Ee("Share2",[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rP=Ee("Star",[["polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2",key:"8f66p6"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const iP=Ee("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sP=Ee("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ag=Ee("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oP=Ee("Utensils",[["path",{d:"M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2",key:"cjf0a3"}],["path",{d:"M7 2v20",key:"1473qp"}],["path",{d:"M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7",key:"1ogz0v"}]]);/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ef=Ee("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),aP={apiKey:"AIzaSyCJO2IQIVtUaM0NV0iltbeid8hFd6cbdnQ",authDomain:"vibetravel-39374.firebaseapp.com",projectId:"vibetravel-39374",storageBucket:"vibetravel-39374.firebasestorage.app",messagingSenderId:"408343885090",appId:"1:408343885090:web:80c286e2ef0c7832b5217b",measurementId:"G-ECPB0N84RJ"},Q0=Gv(aP),Zu=xA(Q0),lP=EC(Q0),uP=new cn,cP="my-vibe-trip-2026",ec=()=>Math.random().toString(36).substr(2,9),hP=()=>{try{return new URLSearchParams(window.location.search).get("trip")||null}catch{return null}},dP=()=>{try{return localStorage.getItem("vibetravel_last_trip_id")}catch{return null}},kg=t=>{try{localStorage.setItem("vibetravel_last_trip_id",t)}catch{}},fP=t=>{if(!t)return"";const e=new Date(t),r=(new Date-e)/1e3;return r<60?"剛剛":r<3600?`${Math.floor(r/60)} 分鐘前`:r<86400?`${Math.floor(r/3600)} 小時前`:`${e.getMonth()+1}/${e.getDate()} ${e.getHours().toString().padStart(2,"0")}:${e.getMinutes().toString().padStart(2,"0")}`},tc={title:"🇻🇳 峴港·會安 6日5夜之旅",subtitle:"2026/01/02 ~ 01/07 | 家族旅行",startDate:"2026-01-02",tags:["峴港 (美溪沙灘)","會安 (古鎮)","巴拿山"],flight:{outbound:{date:"1/2",code:"UO552",route:"HKG 08:25 → DAD 09:20"},inbound:{date:"1/7",code:"UO559",route:"DAD 18:30 → HKG 21:25"}},meta:{lastEditedBy:null,lastEditedPhoto:null,lastEditedAt:null},days:[{id:"day_1",dayNum:1,theme:"峴港初印象：粉紅教堂＋龍橋",themeTags:"市區・美食",activities:[{id:"d1_1",time:"08:25",title:"香港起飛",subtitle:"香港快運 UO552",type:"plane",location:"香港國際機場 T1"},{id:"d1_2",time:"09:20",title:"抵達峴港 & 接機",subtitle:"預約 Grab 或 包車",type:"car",location:"峴港國際機場 T2"},{id:"d1_3",time:"12:00",title:"午餐：越式米線",subtitle:"Mì Quảng 1A",type:"food",location:"Mì Quảng 1A"},{id:"d1_4",time:"14:00",title:"飯店 Check-in",subtitle:"辦理入住手續",type:"stay",location:"美溪沙灘周邊飯店"},{id:"d1_5",time:"16:30",title:"粉紅教堂打卡",subtitle:"免費參觀",type:"camera",location:"Da Nang Cathedral"},{id:"d1_6",time:"19:00",title:"晚餐：越式披薩",subtitle:"Pizza 4P's",type:"food",location:"Pizza 4P's"},{id:"d1_7",time:"21:00",title:"龍橋噴火秀",subtitle:"週五限定活動",type:"sightseeing",location:"Dragon Bridge"}]},{id:"day_2",dayNum:2,theme:"雲端上的樂園：巴拿山",themeTags:"自然・樂園",activities:[]},{id:"day_3",dayNum:3,theme:"古鎮風情：五行山＋會安",themeTags:"文化・夜景",activities:[]},{id:"day_4",dayNum:4,theme:"慢活時光：按摩＋沙灘",themeTags:"放鬆・購物",activities:[]},{id:"day_5",dayNum:5,theme:"山茶半島與最後巡禮",themeTags:"風景・咖啡",activities:[]},{id:"day_6",dayNum:6,theme:"再見峴港",themeTags:"返程",activities:[]}]},nc=t=>wC(lP,"artifacts",cP,"public","data","trips",`trip_${t}`),pP=({onLogin:t})=>P.jsxs("div",{className:"flex h-screen items-center justify-center bg-[#101010] text-gray-200 flex-col p-6",children:[P.jsxs("div",{className:"mb-8 text-center",children:[P.jsx("h1",{className:"text-4xl font-bold text-yellow-500 mb-2",children:"VibeTravel"}),P.jsx("p",{className:"text-gray-400",children:"與朋友一起規劃您的完美旅程"})]}),P.jsxs("button",{onClick:t,className:"flex items-center gap-3 bg-white text-gray-900 px-6 py-3 rounded-full font-bold text-lg hover:bg-gray-100 transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)]",children:[P.jsxs("svg",{className:"w-6 h-6",viewBox:"0 0 24 24",children:[P.jsx("path",{fill:"#4285F4",d:"M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"}),P.jsx("path",{fill:"#34A853",d:"M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"}),P.jsx("path",{fill:"#FBBC05",d:"M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"}),P.jsx("path",{fill:"#EA4335",d:"M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"})]}),"使用 Google 帳號登入"]})]}),mP=({isOpen:t,onClose:e,onJoin:n})=>{const[r,i]=me.useState("");return t?P.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4",children:P.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-sm p-6 shadow-2xl",children:[P.jsxs("div",{className:"flex justify-between items-center mb-4",children:[P.jsx("h3",{className:"text-lg font-bold text-white",children:"加入行程"}),P.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:P.jsx(ef,{size:20})})]}),P.jsxs("p",{className:"text-sm text-gray-400 mb-4",children:["請輸入朋友分享的 ",P.jsx("b",{className:"text-yellow-500",children:"Trip ID"})]}),P.jsx("input",{type:"text",value:r,onChange:s=>i(s.target.value.trim()),placeholder:"例如: x9s8d7f",className:"w-full bg-[#2c2c2e] text-white rounded-xl px-4 py-3 text-lg font-mono focus:outline-none focus:ring-2 focus:ring-yellow-500 mb-4"}),P.jsx("button",{onClick:()=>{r&&n(r)},disabled:!r,className:"w-full py-3 rounded-xl bg-yellow-500 text-black font-bold hover:bg-yellow-400 disabled:opacity-50 transition-colors",children:"加入"})]})}):null},gP=({isOpen:t,onClose:e,onAdd:n})=>{const[r,i]=me.useState("12:00"),[s,o]=me.useState("");return t?P.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4",children:P.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-sm p-6 shadow-2xl animate-in fade-in zoom-in duration-200",children:[P.jsxs("div",{className:"flex justify-between items-center mb-6",children:[P.jsx("h3",{className:"text-lg font-bold text-white",children:"新增活動"}),P.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:P.jsx(ef,{size:20})})]}),P.jsxs("div",{className:"space-y-4",children:[P.jsxs("div",{children:[P.jsx("label",{className:"block text-xs text-gray-500 mb-1",children:"時間 (24小時制)"}),P.jsx("input",{type:"time",value:r,onChange:l=>i(l.target.value),className:"w-full bg-[#2c2c2e] text-white rounded-xl px-4 py-3 text-xl font-mono focus:outline-none focus:ring-2 focus:ring-yellow-500"})]}),P.jsxs("div",{children:[P.jsx("label",{className:"block text-xs text-gray-500 mb-1",children:"活動名稱"}),P.jsx("input",{type:"text",value:s,onChange:l=>o(l.target.value),placeholder:"例如：午餐、景點...",autoFocus:!0,className:"w-full bg-[#2c2c2e] text-white rounded-xl px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"})]})]}),P.jsx("button",{onClick:()=>{s&&n(r,s)},disabled:!s,className:"w-full mt-6 py-3 rounded-xl bg-yellow-500 text-black font-bold hover:bg-yellow-400 disabled:opacity-50 transition-colors",children:"確認新增"})]})}):null},yP=({isOpen:t,onClose:e,tripId:n})=>{if(!t)return null;const r=`${window.location.origin}${window.location.pathname}?trip=${n}`,i=`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(r)}`;return P.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4",children:P.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-sm p-8 shadow-2xl flex flex-col items-center",children:[P.jsxs("div",{className:"w-full flex justify-between items-center mb-6",children:[P.jsx("h3",{className:"text-lg font-bold text-white",children:"手機掃描開啟"}),P.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:P.jsx(ef,{size:20})})]}),P.jsx("div",{className:"bg-white p-2 rounded-xl mb-4",children:P.jsx("img",{src:i,alt:"QR Code",className:"w-48 h-48"})}),P.jsxs("p",{className:"text-sm text-gray-400 text-center mb-6",children:["使用手機相機掃描，",P.jsx("br",{}),"即可在手機上瀏覽與編輯。"]}),P.jsxs("div",{className:"w-full bg-[#2c2c2e] p-3 rounded-lg flex items-center justify-between",children:[P.jsx("span",{className:"text-xs text-gray-500 font-mono truncate mr-2",children:r}),P.jsx("button",{onClick:()=>navigator.clipboard.writeText(r),className:"text-yellow-500 hover:text-yellow-400",children:P.jsx(G0,{size:16})})]})]})})};function vP(){var he;const[t,e]=me.useState(null),[n,r]=me.useState(null),[i,s]=me.useState(!0),[o,l]=me.useState(null),[u,h]=me.useState(tc),[f,g]=me.useState("day_1"),[y,k]=me.useState(!1),[x,D]=me.useState(!1),[O,I]=me.useState(""),[w,S]=me.useState(!1),[V,z]=me.useState(!1),[U,_]=me.useState(!1),[m,v]=me.useState("idle");me.useEffect(()=>{const F=vS(Zu,X=>{e(X),s(!1)});return()=>F()},[]);const T=async()=>{try{await US(Zu,uP)}catch(F){console.error("Login failed",F),l("登入失敗，請確認您已在 Firebase 開啟 Google Auth")}},A=()=>_S(Zu),R=async(F,X=!1)=>{s(!0),r(F),l(null),kg(F);const re=`?trip=${F}`;try{window.history.pushState({path:re},"",re)}catch{}if(X){const ce=nc(F);try{const se={...tc,meta:{lastEditedBy:t.displayName||"匿名用戶",lastEditedPhoto:t.photoURL,lastEditedAt:new Date().toISOString()}};await Eg(ce,se),h(se),g(tc.days[0].id)}catch(se){console.error("Create trip failed",se),l("建立失敗：請檢查資料庫權限")}s(!1)}};me.useEffect(()=>{if(!t)return;let F=n;if(!F){const ce=hP(),se=dP();if(ce)F=ce,r(ce),kg(ce);else if(se){F=se,r(se);const ze=`?trip=${se}`;try{window.history.pushState({path:ze},"",ze)}catch{}}else{const ze=ec();R(ze,!0);return}}const X=nc(F),re=bC(X,ce=>{if(ce.exists()){const se=ce.data();if(h(ze=>({...ze,...se})),se.days&&se.days.length>0){const ze=se.days.some(sn=>sn.id===f);(!f||!ze)&&g(se.days[0].id)}v("saved")}s(!1)},ce=>{console.error("Snapshot error:",ce),l("讀取錯誤，請稍後再試"),s(!1),v("error")});return()=>re()},[t,n]);const E=async F=>{const X={...F,meta:{lastEditedBy:t.displayName||"匿名用戶",lastEditedPhoto:t.photoURL,lastEditedAt:new Date().toISOString()}};if(h(X),v("saving"),!n||!t){v("error");return}try{await Eg(nc(n),X),v("saved"),o&&l(null)}catch(re){console.error("Save error:",re),v("error")}},be=(F,X,re,ce)=>{const se=u.days.map(ze=>{if(ze.id!==F)return ze;const sn=ze.activities.map(Wt=>Wt.id!==X?Wt:{...Wt,[re]:ce});return re==="time"&&sn.sort((Wt,zr)=>Wt.time.localeCompare(zr.time)),{...ze,activities:sn}});E({...u,days:se})},rn=(F,X)=>{const re={id:ec(),time:F,title:X,subtitle:"",type:"sightseeing",location:""},ce=u.days.map(se=>se.id!==f?se:{...se,activities:[...se.activities,re].sort((ze,sn)=>ze.time.localeCompare(sn.time))});E({...u,days:ce}),_(!1)},ur=(F,X)=>{const re=u.days.map(ce=>ce.id!==F?ce:{...ce,activities:ce.activities.filter(se=>se.id!==X)});E({...u,days:re})},Ot=()=>{const F=u.days.length+1,X={id:ec(),dayNum:F,theme:"新的一天",themeTags:"主題",activities:[]};E({...u,days:[...u.days,X]}),g(X.id)},B=()=>{let F=`${window.location.origin}${window.location.pathname}?trip=${n}`;navigator.clipboard.writeText(F),I("已複製連結"),D(!0),setTimeout(()=>D(!1),3e3)},K=F=>{const X={size:16,strokeWidth:2.5};switch(F){case"food":return P.jsx(oP,{...X,className:"text-orange-500"});case"transport":return P.jsx(KC,{...X,className:"text-blue-400"});case"plane":return P.jsx(tP,{...X,className:"text-blue-400"});case"car":return P.jsx(WC,{...X,className:"text-blue-400"});case"stay":return P.jsx($C,{...X,className:"text-indigo-400"});case"camera":return P.jsx(HC,{...X,className:"text-green-500"});case"coffee":return P.jsx(YC,{...X,className:"text-amber-500"});case"sightseeing":return P.jsx(rP,{...X,className:"text-yellow-500"});case"boat":return P.jsx(Tg,{...X,className:"text-teal-400"});default:return P.jsx(Tg,{...X,className:"text-gray-400"})}},Z=F=>{switch(F){case"food":return"bg-orange-500/10 border-orange-500/30";case"plane":case"car":case"transport":return"bg-blue-500/10 border-blue-500/30";case"stay":return"bg-indigo-500/10 border-indigo-500/30";case"camera":return"bg-green-500/10 border-green-500/30";case"coffee":return"bg-amber-500/10 border-amber-500/30";case"sightseeing":return"bg-yellow-500/10 border-yellow-500/30";default:return"bg-gray-700/30 border-gray-600"}};if(i)return P.jsx("div",{className:"flex h-screen items-center justify-center bg-[#101010] text-yellow-500",children:P.jsx(Sg,{size:32,className:"animate-spin"})});if(!t)return P.jsx(pP,{onLogin:T});const te=(u.days||[]).find(F=>F.id===f)||(u.days||[])[0];return P.jsxs("div",{className:"min-h-screen bg-[#101010] text-gray-200 font-sans pb-20 selection:bg-yellow-500/30",children:[P.jsx(mP,{isOpen:w,onClose:()=>S(!1),onJoin:F=>{S(!1),R(F,!1)}}),P.jsx(yP,{isOpen:V,onClose:()=>z(!1),tripId:n}),P.jsx(gP,{isOpen:U,onClose:()=>_(!1),onAdd:rn}),P.jsxs("div",{className:"bg-gray-900 px-4 py-2 flex justify-between items-center border-b border-gray-800",children:[P.jsx("div",{className:"flex items-center gap-2 text-xs text-gray-400",children:(he=u.meta)!=null&&he.lastEditedBy?P.jsxs(P.Fragment,{children:[P.jsx("span",{children:"最後修改:"}),u.meta.lastEditedPhoto?P.jsx("img",{src:u.meta.lastEditedPhoto,className:"w-4 h-4 rounded-full",alt:""}):P.jsx(Ag,{size:14}),P.jsx("span",{className:"text-yellow-500",children:u.meta.lastEditedBy}),P.jsxs("span",{children:["• ",fP(u.meta.lastEditedAt)]})]}):P.jsx("span",{children:"新行程"})}),P.jsxs("div",{className:"flex items-center gap-3",children:[P.jsxs("div",{className:"flex items-center gap-2 bg-gray-800 rounded-full px-2 py-1 pr-3",children:[t.photoURL?P.jsx("img",{src:t.photoURL,alt:t.displayName,className:"w-5 h-5 rounded-full"}):P.jsx(Ag,{size:16,className:"text-gray-400"}),P.jsx("span",{className:"text-xs font-bold text-gray-300",children:t.displayName||"旅客"})]}),P.jsx("button",{onClick:A,title:"登出",className:"text-gray-500 hover:text-white",children:P.jsx(ZC,{size:16})})]})]}),P.jsx("div",{className:"bg-[#101010] px-5 pt-6 pb-2 sticky top-0 z-20 shadow-md",children:P.jsxs("div",{className:"max-w-md mx-auto",children:[P.jsxs("div",{className:"flex justify-between items-start mb-2",children:[P.jsxs("div",{children:[P.jsx("input",{className:"text-2xl font-bold text-yellow-500 w-full bg-transparent outline-none placeholder-yellow-800",value:u.title,onChange:F=>E({...u,title:F.target.value})}),P.jsx("input",{className:"text-xs text-gray-400 mt-1 w-full bg-transparent outline-none",value:u.subtitle||"",placeholder:"日期 | 天數 | 旅行人數",onChange:F=>E({...u,subtitle:F.target.value})})]}),P.jsxs("div",{className:"flex gap-3",children:[P.jsx("button",{onClick:()=>S(!0),title:"加入行程",children:P.jsx(JC,{size:20,className:"text-gray-500 hover:text-white"})}),P.jsx("button",{onClick:()=>z(!0),title:"手機 QR Code",children:P.jsx(nP,{size:20,className:"text-gray-500 hover:text-white"})}),P.jsx("button",{onClick:B,title:"分享連結/代碼",children:P.jsx(G0,{size:20,className:"text-yellow-500 hover:text-yellow-400"})})]})]}),P.jsxs("div",{className:"flex flex-wrap gap-2 mb-4",children:[(u.tags||[]).map((F,X)=>P.jsx("span",{className:"px-3 py-1 bg-orange-500/20 text-orange-400 text-xs rounded-full font-medium border border-orange-500/20",children:F},X)),P.jsx("button",{className:"px-2 py-1 text-gray-600 text-xs border border-gray-800 rounded-full hover:border-gray-600",children:"+"})]}),P.jsxs("div",{className:"absolute top-4 right-4 flex items-center gap-1 text-xs",children:[m==="saving"&&P.jsxs("span",{className:"text-yellow-500 flex items-center animate-pulse",children:[P.jsx(Sg,{size:12,className:"mr-1"})," 儲存中..."]}),m==="saved"&&P.jsxs("span",{className:"text-green-500 flex items-center",children:[P.jsx(XC,{size:12,className:"mr-1"})," 已同步"]}),m==="error"&&P.jsxs("span",{className:"text-red-500 flex items-center",children:[P.jsx(QC,{size:12,className:"mr-1"})," 未同步"]})]}),P.jsxs("div",{className:"flex overflow-x-auto no-scrollbar border-b border-gray-800",children:[(u.days||[]).map((F,X)=>{const re=te&&te.id===F.id;return P.jsxs("button",{onClick:()=>g(F.id),className:`flex-shrink-0 px-4 py-3 text-sm font-medium transition-all border-b-2 relative ${re?"text-yellow-500 border-yellow-500":"text-gray-500 border-transparent hover:text-gray-300"}`,children:["Day ",X+1]},F.id)}),P.jsx("button",{onClick:Ot,className:"px-4 py-3 text-gray-600 hover:text-yellow-500",children:P.jsx(Ig,{size:16})})]})]})}),o&&P.jsxs("div",{className:"bg-red-900/90 text-white px-4 py-3 text-sm flex items-center justify-center gap-2 border-b border-red-500 sticky top-0 z-50 animate-pulse",children:[P.jsx(sP,{size:16,className:"text-yellow-300"}),P.jsx("span",{children:o})]}),P.jsx("div",{className:"max-w-md mx-auto px-5 py-4",children:P.jsxs("div",{className:"space-y-0 relative",children:[P.jsxs("div",{className:"flex items-center gap-2 mb-4 text-gray-400 text-sm",children:[P.jsx(GC,{size:16})," ",P.jsx("span",{children:"每日行程時間軸"})]}),te&&(te.activities||[]).map((F,X)=>P.jsxs("div",{className:"relative pl-0 group flex",children:[P.jsx("div",{className:"w-14 pt-1 pr-2 flex-shrink-0 text-right",children:P.jsx("input",{type:"time",value:F.time,onChange:re=>be(te.id,F.id,"time",re.target.value),className:"text-sm font-bold text-gray-300 bg-transparent w-full text-right outline-none focus:text-yellow-500 font-mono"})}),P.jsxs("div",{className:"relative flex flex-col items-center mr-4",children:[P.jsx("div",{className:`absolute w-[2px] bg-[#333] ${X===0?"top-3 h-[calc(100%-12px)]":"h-full"} ${X===te.activities.length-1?"h-4":""}`}),P.jsx("div",{className:`relative z-10 w-8 h-8 rounded-full border-2 flex items-center justify-center transition-transform hover:scale-110 ${Z(F.type)}`,children:K(F.type)})]}),P.jsx("div",{className:"flex-1 pb-8 min-w-0",children:P.jsxs("div",{className:"flex justify-between items-start group-hover:bg-[#1c1c1e] p-2 -mt-2 -ml-2 rounded-lg transition-colors",children:[P.jsxs("div",{className:"flex-1",children:[P.jsx("input",{value:F.title,placeholder:"行程標題",onChange:re=>be(te.id,F.id,"title",re.target.value),className:"w-full text-base font-bold text-gray-200 bg-transparent outline-none placeholder-gray-700"}),P.jsxs("div",{className:"flex flex-col mt-0.5",children:[P.jsx("input",{value:F.subtitle||"",placeholder:"備註 / 航班號 / 費用",onChange:re=>be(te.id,F.id,"subtitle",re.target.value),className:"text-xs text-gray-500 bg-transparent outline-none placeholder-gray-800"}),P.jsxs("div",{className:"flex items-center mt-1",children:[P.jsx("input",{value:F.location,placeholder:"地點...",onChange:re=>be(te.id,F.id,"location",re.target.value),className:"text-xs text-gray-500 bg-transparent outline-none placeholder-gray-800 min-w-0"}),F.location&&P.jsx("a",{href:`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(F.location)}`,target:"_blank",rel:"noopener noreferrer",className:"ml-2 text-yellow-600 hover:text-yellow-500",children:P.jsx(eP,{size:12})})]})]})]}),P.jsxs("div",{className:"opacity-0 group-hover:opacity-100 transition-opacity flex flex-col gap-2 ml-2",children:[P.jsxs("select",{value:F.type,onChange:re=>be(te.id,F.id,"type",re.target.value),className:"bg-gray-800 text-xs text-gray-400 rounded px-1 py-0.5 outline-none border border-gray-700",children:[P.jsx("option",{value:"plane",children:"飛機"}),P.jsx("option",{value:"car",children:"汽車"}),P.jsx("option",{value:"transport",children:"交通"}),P.jsx("option",{value:"food",children:"餐廳"}),P.jsx("option",{value:"stay",children:"住宿"}),P.jsx("option",{value:"sightseeing",children:"景點"}),P.jsx("option",{value:"camera",children:"拍照"})]}),P.jsx("button",{onClick:()=>ur(te.id,F.id),className:"text-gray-600 hover:text-red-500 self-end",children:P.jsx(iP,{size:14})})]})]})})]},F.id)),te&&P.jsxs("div",{className:"pl-14 flex items-center gap-4",children:[P.jsx("div",{className:"w-8 flex justify-center",children:P.jsx("div",{className:"w-[2px] h-4 bg-[#333]"})}),P.jsxs("button",{onClick:()=>_(!0),className:"flex items-center gap-2 text-gray-500 hover:text-yellow-500 text-sm py-2",children:[P.jsx("div",{className:"w-6 h-6 rounded-full border border-dashed border-gray-600 flex items-center justify-center",children:P.jsx(Ig,{size:14})}),"新增行程"]})]})]})}),P.jsxs("div",{className:`fixed bottom-6 left-1/2 -translate-x-1/2 bg-yellow-500 text-black px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2 transition-all ${x?"opacity-100 translate-y-0":"opacity-0 translate-y-4 pointer-events-none"}`,children:[P.jsx(qC,{size:16})," ",O]})]})}Uv(document.getElementById("root")).render(P.jsx(me.StrictMode,{children:P.jsx(vP,{})}));
