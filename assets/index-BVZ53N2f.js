 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,K){var J=z.length;z.push(K);e:for(;0<J;){var ge=J-1>>>1,ue=z[ge];if(0<i(ue,K))z[ge]=K,z[J]=ue,J=ge;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var K=z[0],J=z.pop();if(J!==K){z[0]=J;e:for(var ge=0,ue=z.length,re=ue>>>1;ge<re;){var Ct=2*(ge+1)-1,Pt=z[Ct],xt=Ct+1,Nt=z[xt];if(0>i(Pt,J))xt<ue&&0>i(Nt,Pt)?(z[ge]=Nt,z[xt]=J,ge=xt):(z[ge]=Pt,z[Ct]=J,ge=Ct);else if(xt<ue&&0>i(Nt,J))z[ge]=Nt,z[xt]=J,ge=xt;else break e}}return K}function i(z,K){var J=z.sortIndex-K.sortIndex;return J!==0?J:z.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,g=null,y=3,k=!1,x=!1,D=!1,O=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(z){for(var K=n(h);K!==null;){if(K.callback===null)r(h);else if(K.startTime<=z)r(h),K.sortIndex=K.expirationTime,e(u,K);else break;K=n(h)}}function V(z){if(D=!1,S(z),!x)if(n(u)!==null)x=!0,jt(j);else{var K=n(h);K!==null&&zt(V,K.startTime-z)}}function j(z,K){x=!1,D&&(D=!1,I(m),m=-1),k=!0;var J=y;try{for(S(K),g=n(u);g!==null&&(!(g.expirationTime>K)||z&&!A());){var ge=g.callback;if(typeof ge=="function"){g.callback=null,y=g.priorityLevel;var ue=ge(g.expirationTime<=K);K=t.unstable_now(),typeof ue=="function"?g.callback=ue:g===n(u)&&r(u),S(K)}else r(u);g=n(u)}if(g!==null)var re=!0;else{var Ct=n(h);Ct!==null&&zt(V,Ct.startTime-K),re=!1}return re}finally{g=null,y=J,k=!1}}var F=!1,_=null,m=-1,v=5,E=-1;function A(){return!(t.unstable_now()-E<v)}function R(){if(_!==null){var z=t.unstable_now();E=z;var K=!0;try{K=_(!0,z)}finally{K?T():(F=!1,_=null)}}else F=!1}var T;if(typeof w=="function")T=function(){w(R)};else if(typeof MessageChannel<"u"){var at=new MessageChannel,pt=at.port2;at.port1.onmessage=R,T=function(){pt.postMessage(null)}}else T=function(){O(R,0)};function jt(z){_=z,F||(F=!0,T())}function zt(z,K){m=O(function(){z(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){x||k||(x=!0,jt(j))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):v=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return y},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(z){switch(y){case 1:case 2:case 3:var K=3;break;default:K=y}var J=y;y=K;try{return z()}finally{y=J}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,K){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var J=y;y=z;try{return K()}finally{y=J}},t.unstable_scheduleCallback=function(z,K,J){var ge=t.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?ge+J:ge):J=ge,z){case 1:var ue=-1;break;case 2:ue=250;break;case 5:ue=1073741823;break;case 4:ue=1e4;break;default:ue=5e3}return ue=J+ue,z={id:f++,callback:K,priorityLevel:z,startTime:J,expirationTime:ue,sortIndex:-1},J>ge?(z.sortIndex=J,e(h,z),n(u)===null&&z===n(h)&&(D?(I(m),m=-1):D=!0,zt(V,J-ge))):(z.sortIndex=ue,e(u,z),x||k||(x=!0,jt(j))),z},t.unstable_shouldYield=A,t.unstable_wrapCallback=function(z){var K=y;return function(){var J=y;y=K;try{return z.apply(this,arguments)}finally{y=J}}}})(Wg);Hg.exports=Wg;var Qw=Hg.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uf=ke("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),lP={apiKey:"AIzaSyCJO2IQIVtUaM0NV0iltbeid8hFd6cbdnQ",authDomain:"vibetravel-39374.firebaseapp.com",projectId:"vibetravel-39374",storageBucket:"vibetravel-39374.firebasestorage.app",messagingSenderId:"408343885090",appId:"1:408343885090:web:80c286e2ef0c7832b5217b",measurementId:"G-ECPB0N84RJ"},tw=Zv(lP),Ta=OA(tw),uP=AC(tw),cP=new yn,hP="my-vibe-trip-2026",uc=()=>Math.random().toString(36).substr(2,9),dP=()=>{try{return new URLSearchParams(window.location.search).get("trip")||null}catch{return null}},fP=()=>{try{return localStorage.getItem("vibetravel_last_trip_id")}catch{return null}},Ng=t=>{try{localStorage.setItem("vibetravel_last_trip_id",t)}catch{}},pP=t=>{if(!t)return"";try{const e=new Date(t);if(isNaN(e.getTime()))return"";const r=(new Date-e)/1e3;return r<60?"剛剛":r<3600?`${Math.floor(r/60)} 分鐘前`:r<86400?`${Math.floor(r/3600)} 小時前`:`${e.getMonth()+1}/${e.getDate()} ${e.getHours().toString().padStart(2,"0")}:${e.getMinutes().toString().padStart(2,"0")}`}catch{return""}},cc={title:"🇻🇳 峴港·會安 6日5夜之旅",subtitle:"2026/01/02 ~ 01/07 | 家族旅行",startDate:"2026-01-02",tags:["峴港 (美溪沙灘)","會安 (古鎮)","巴拿山"],flight:{outbound:{date:"1/2",code:"UO552",route:"HKG 08:25 → DAD 09:20"},inbound:{date:"1/7",code:"UO559",route:"DAD 18:30 → HKG 21:25"}},meta:{lastEditedBy:null,lastEditedPhoto:null,lastEditedAt:null},days:[{id:"day_1",dayNum:1,theme:"峴港初印象：粉紅教堂＋龍橋",themeTags:"市區・美食",activities:[{id:"d1_1",time:"08:25",title:"香港起飛",subtitle:"香港快運 UO552",type:"plane",location:"香港國際機場 T1"},{id:"d1_2",time:"09:20",title:"抵達峴港 & 接機",subtitle:"預約 Grab 或 包車",type:"car",location:"峴港國際機場 T2"},{id:"d1_3",time:"12:00",title:"午餐：越式米線",subtitle:"Mì Quảng 1A",type:"food",location:"Mì Quảng 1A"},{id:"d1_4",time:"14:00",title:"飯店 Check-in",subtitle:"辦理入住手續",type:"stay",location:"美溪沙灘周邊飯店"},{id:"d1_5",time:"16:30",title:"粉紅教堂打卡",subtitle:"免費參觀",type:"camera",location:"Da Nang Cathedral"},{id:"d1_6",time:"19:00",title:"晚餐：越式披薩",subtitle:"Pizza 4P's",type:"food",location:"Pizza 4P's"},{id:"d1_7",time:"21:00",title:"龍橋噴火秀",subtitle:"週五限定活動",type:"sightseeing",location:"Dragon Bridge"}]},{id:"day_2",dayNum:2,theme:"雲端上的樂園：巴拿山",themeTags:"自然・樂園",activities:[]},{id:"day_3",dayNum:3,theme:"古鎮風情：五行山＋會安",themeTags:"文化・夜景",activities:[]},{id:"day_4",dayNum:4,theme:"慢活時光：按摩＋沙灘",themeTags:"放鬆・購物",activities:[]},{id:"day_5",dayNum:5,theme:"山茶半島與最後巡禮",themeTags:"風景・咖啡",activities:[]},{id:"day_6",dayNum:6,theme:"再見峴港",themeTags:"返程",activities:[]}]},hc=t=>SC(uP,"artifacts",hP,"public","data","trips",`trip_${t}`),mP=({isOpen:t,onClose:e,onJoin:n})=>{const[r,i]=de.useState("");return t?P.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 z-50",children:P.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-sm p-6 shadow-2xl animate-in fade-in zoom-in duration-200",children:[P.jsxs("div",{className:"flex justify-between items-center mb-4",children:[P.jsx("h3",{className:"text-lg font-bold text-white",children:"加入行程"}),P.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:P.jsx(uf,{size:20})})]}),P.jsxs("p",{className:"text-sm text-gray-400 mb-4",children:["請輸入朋友分享的 ",P.jsx("b",{className:"text-yellow-500",children:"Trip ID"})]}),P.jsx("input",{type:"text",value:r,onChange:s=>i(s.target.value.trim()),placeholder:"例如: x9s8d7f",className:"w-full bg-[#2c2c2e] text-white rounded-xl px-4 py-3 text-lg font-mono focus:outline-none focus:ring-2 focus:ring-yellow-500 mb-4"}),P.jsx("button",{onClick:()=>{r&&n(r)},disabled:!r,className:"w-full py-3 rounded-xl bg-yellow-500 text-black font-bold hover:bg-yellow-400 disabled:opacity-50 transition-colors",children:"加入"})]})}):null},gP=({isOpen:t,onClose:e,onAdd:n})=>{const[r,i]=de.useState("12:00"),[s,o]=de.useState("");return t?P.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 z-50",children:P.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-sm p-6 shadow-2xl animate-in fade-in zoom-in duration-200",children:[P.jsxs("div",{className:"flex justify-between items-center mb-6",children:[P.jsx("h3",{className:"text-lg font-bold text-white",children:"新增活動"}),P.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:P.jsx(uf,{size:20})})]}),P.jsxs("div",{className:"space-y-4",children:[P.jsxs("div",{children:[P.jsx("label",{className:"block text-xs text-gray-500 mb-1",children:"時間 (24小時制)"}),P.jsx("input",{type:"time",value:r,onChange:l=>i(l.target.value),className:"w-full bg-[#2c2c2e] text-white rounded-xl px-4 py-3 text-xl font-mono focus:outline-none focus:ring-2 focus:ring-yellow-500"})]}),P.jsxs("div",{children:[P.jsx("label",{className:"block text-xs text-gray-500 mb-1",children:"活動名稱"}),P.jsx("input",{type:"text",value:s,onChange:l=>o(l.target.value),placeholder:"例如：午餐、景點...",autoFocus:!0,className:"w-full bg-[#2c2c2e] text-white rounded-xl px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"})]})]}),P.jsx("button",{onClick:()=>{s&&n(r,s)},disabled:!s,className:"w-full mt-6 py-3 rounded-xl bg-yellow-500 text-black font-bold hover:bg-yellow-400 disabled:opacity-50 transition-colors",children:"確認新增"})]})}):null},yP=({isOpen:t,onClose:e,tripId:n,isBlobEnv:r})=>{if(!t)return null;const i=r?window.location.href:`${window.location.origin}${window.location.pathname}?trip=${n}`,s=`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(i)}`;return P.jsx("div",{className:"fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 z-50",children:P.jsxs("div",{className:"bg-[#1c1c1e] border border-gray-700 rounded-2xl w-full max-w-sm p-8 shadow-2xl flex flex-col items-center animate-in fade-in zoom-in duration-200",children:[P.jsxs("div",{className:"w-full flex justify-between items-center mb-6",children:[P.jsx("h3",{className:"text-lg font-bold text-white",children:"手機掃描開啟"}),P.jsx("button",{onClick:e,className:"text-gray-400 hover:text-white",children:P.jsx(uf,{size:20})})]}),P.jsx("div",{className:"bg-white p-2 rounded-xl mb-4",children:P.jsx("img",{src:s,alt:"QR Code",className:"w-48 h-48"})}),r?P.jsxs("div",{className:"text-center mb-4",children:[P.jsx("p",{className:"text-sm text-yellow-500 font-bold mb-1",children:"⚠️ 預覽模式注意"}),P.jsxs("p",{className:"text-xs text-gray-400",children:["此為暫存連結 (blob)，手機掃描可能無法開啟。",P.jsx("br",{}),"請部署到正式網域後再使用此功能。"]})]}):P.jsxs("p",{className:"text-sm text-gray-400 text-center mb-6",children:["使用手機相機掃描，",P.jsx("br",{}),"即可在手機上瀏覽與編輯。"]}),P.jsxs("div",{className:"w-full bg-[#2c2c2e] p-3 rounded-lg flex items-center justify-between",children:[P.jsx("span",{className:"text-xs text-gray-500 font-mono truncate mr-2",children:i}),P.jsx("button",{onClick:()=>{navigator.clipboard.writeText(i)},className:"text-yellow-500 hover:text-yellow-400",children:P.jsx(ew,{size:16})})]})]})})};function vP(){var Ct,Pt,xt,Nt,Mo,Lo,yr,vr,Qr,Xr,Yr,Jr,es;const[t,e]=de.useState(null),[n,r]=de.useState(null),[i,s]=de.useState(!0),[o,l]=de.useState(null),[u,h]=de.useState(cc),[f,g]=de.useState("day_1"),[y,k]=de.useState(!1),[x,D]=de.useState(!1),[O,I]=de.useState(""),[w,S]=de.useState(!1),[V,j]=de.useState(!1),[F,_]=de.useState(!1),[m,v]=de.useState("idle"),[E,A]=de.useState(!1);de.useEffect(()=>{A(window.location.protocol==="blob:"||window.location.protocol==="file:")},[]),de.useEffect(()=>{const $=TS(Ta,Z=>{Z?(e(Z),s(!1)):gS(Ta).catch(le=>{console.error("Auto guest login failed",le),s(!1)})});return()=>$()},[]);const R=async()=>{try{await $S(Ta,cP)}catch($){console.error("Login failed",$),l("登入失敗，請確認您已在 Firebase 開啟 Google Auth")}},T=async()=>{await IS(Ta)},at=async($,Z=!1)=>{s(!0),r($),l(null),Ng($);const le=`?trip=${$}`;try{window.history.pushState({path:le},"",le)}catch{}if(Z){const ye=hc($);try{const fe={...cc,meta:{lastEditedBy:(t==null?void 0:t.displayName)||"匿名用戶",lastEditedPhoto:t==null?void 0:t.photoURL,lastEditedAt:new Date().toISOString()}};await Ag(ye,fe),h(fe),g(cc.days[0].id)}catch(fe){console.error("Create trip failed",fe),l("建立失敗：請檢查資料庫權限")}s(!1)}};de.useEffect(()=>{if(!t)return;let $=n;if(!$){const ye=dP(),fe=fP();if(ye)$=ye,r(ye),Ng(ye);else if(fe){$=fe,r(fe);const ze=`?trip=${fe}`;try{window.history.pushState({path:ze},"",ze)}catch{}}else{const ze=uc();at(ze,!0);return}}const Z=hc($),le=zC(Z,ye=>{if(ye.exists()){const fe=ye.data();if(h(ze=>({...ze,...fe})),fe.days&&fe.days.length>0){const ze=fe.days.some(Bt=>Bt.id===f);(!f||!ze)&&g(fe.days[0].id)}v("saved")}s(!1)},ye=>{console.error("Snapshot error:",ye),l("讀取錯誤，請稍後再試"),s(!1),v("error")});return()=>le()},[t,n]);const pt=async $=>{if(t!=null&&t.isAnonymous){v("error"),I("訪客無法儲存，請先登入"),D(!0),setTimeout(()=>D(!1),3e3);return}const Z={...$,meta:{lastEditedBy:t.displayName||"使用者",lastEditedPhoto:t.photoURL,lastEditedAt:new Date().toISOString()}};if(h(Z),v("saving"),!n||!t){v("error");return}try{await Ag(hc(n),Z),v("saved"),o&&l(null)}catch(le){console.error("Save error:",le),v("error")}},jt=($,Z,le,ye)=>{const fe=u.days.map(ze=>{if(ze.id!==$)return ze;const Bt=ze.activities.map(dn=>dn.id!==Z?dn:{...dn,[le]:ye});return le==="time"&&Bt.sort((dn,bo)=>dn.time.localeCompare(bo.time)),{...ze,activities:Bt}});pt({...u,days:fe})},zt=($,Z)=>{const le={id:uc(),time:$,title:Z,subtitle:"",type:"sightseeing",location:""},ye=u.days.map(fe=>fe.id!==f?fe:{...fe,activities:[...fe.activities,le].sort((ze,Bt)=>ze.time.localeCompare(Bt.time))});pt({...u,days:ye}),_(!1)},z=($,Z)=>{const le=u.days.map(ye=>ye.id!==$?ye:{...ye,activities:ye.activities.filter(fe=>fe.id!==Z)});pt({...u,days:le})},K=()=>{const $=u.days.length+1,Z={id:uc(),dayNum:$,theme:"新的一天",themeTags:"主題",activities:[]};pt({...u,days:[...u.days,Z]}),g(Z.id)},J=()=>{let $=E?n:`${window.location.origin}${window.location.pathname}?trip=${n}`;navigator.clipboard.writeText($),I("已複製連結"),D(!0),setTimeout(()=>D(!1),3e3)},ge=$=>{const Z={size:16,strokeWidth:2.5};switch($){case"food":return P.jsx(aP,{...Z,className:"text-orange-500"});case"transport":return P.jsx(YC,{...Z,className:"text-blue-400"});case"plane":return P.jsx(Rg,{...Z,className:"text-blue-400"});case"car":return P.jsx(QC,{...Z,className:"text-blue-400"});case"stay":return P.jsx(KC,{...Z,className:"text-indigo-400"});case"camera":return P.jsx(GC,{...Z,className:"text-green-500"});case"coffee":return P.jsx(tP,{...Z,className:"text-amber-500"});case"sightseeing":return P.jsx(iP,{...Z,className:"text-yellow-500"});case"boat":return P.jsx(lc,{...Z,className:"text-teal-400"});default:return P.jsx(lc,{...Z,className:"text-gray-400"})}},ue=$=>{switch($){case"food":return"bg-orange-500/10 border-orange-500/30";case"plane":case"car":case"transport":return"bg-blue-500/10 border-blue-500/30";case"stay":return"bg-indigo-500/10 border-indigo-500/30";case"camera":return"bg-green-500/10 border-green-500/30";case"coffee":return"bg-amber-500/10 border-amber-500/30";case"sightseeing":return"bg-yellow-500/10 border-yellow-500/30";default:return"bg-gray-700/30 border-gray-600"}};if(i)return P.jsx("div",{className:"flex h-screen items-center justify-center bg-[#101010] text-yellow-500",children:P.jsx(Pg,{size:32,className:"animate-spin"})});if(!t)return null;const re=(u.days||[]).find($=>$.id===f)||(u.days||[])[0];return P.jsxs("div",{className:"min-h-screen bg-[#101010] text-gray-200 font-sans pb-20 selection:bg-yellow-500/30",children:[P.jsx(mP,{isOpen:w,onClose:()=>S(!1),onJoin:$=>{S(!1),at($,!1)}}),P.jsx(yP,{isOpen:V,onClose:()=>j(!1),tripId:n,isBlobEnv:E}),P.jsx(gP,{isOpen:F,onClose:()=>_(!1),onAdd:zt}),P.jsxs("div",{className:"bg-gray-900 px-4 py-2 flex justify-between items-center border-b border-gray-800",children:[P.jsx("div",{className:"flex items-center gap-2 text-xs text-gray-400",children:(Ct=u.meta)!=null&&Ct.lastEditedBy?P.jsxs(P.Fragment,{children:[P.jsx("span",{children:"最後修改:"}),u.meta.lastEditedPhoto?P.jsx("img",{src:u.meta.lastEditedPhoto,className:"w-4 h-4 rounded-full",alt:""}):P.jsx(xg,{size:14}),P.jsx("span",{className:"text-yellow-500",children:u.meta.lastEditedBy}),P.jsxs("span",{children:["• ",pP(u.meta.lastEditedAt)]})]}):P.jsx("span",{children:"新行程"})}),P.jsx("div",{className:"flex items-center gap-3",children:t!=null&&t.isAnonymous?P.jsxs("button",{onClick:R,className:"flex items-center gap-2 bg-yellow-500 text-black px-3 py-1.5 rounded-full text-xs font-bold hover:bg-yellow-400 transition-colors shadow-[0_0_10px_rgba(234,179,8,0.3)] animate-pulse",children:[P.jsx(kg,{size:14}),"登入 Google 以編輯"]}):P.jsxs(P.Fragment,{children:[P.jsxs("div",{className:"flex items-center gap-2 bg-gray-800 rounded-full px-2 py-1 pr-3",children:[t.photoURL?P.jsx("img",{src:t.photoURL,alt:t.displayName,className:"w-5 h-5 rounded-full"}):P.jsx(xg,{size:16,className:"text-gray-400"}),P.jsx("span",{className:"text-xs font-bold text-gray-300",children:t.displayName})]}),P.jsx("button",{onClick:T,title:"登出",className:"text-gray-500 hover:text-white",children:P.jsx(nP,{size:16})})]})})]}),P.jsx("div",{className:"bg-[#101010] px-5 pt-6 pb-2 sticky top-0 z-20 shadow-md",children:P.jsxs("div",{className:"max-w-md mx-auto",children:[P.jsxs("div",{className:"flex justify-between items-start mb-2",children:[P.jsxs("div",{children:[P.jsx("input",{className:"text-2xl font-bold text-yellow-500 w-full bg-transparent outline-none placeholder-yellow-800 disabled:opacity-80 disabled:cursor-not-allowed",value:u.title,onChange:$=>pt({...u,title:$.target.value}),disabled:t==null?void 0:t.isAnonymous}),P.jsx("input",{className:"text-xs text-gray-400 mt-1 w-full bg-transparent outline-none disabled:opacity-80 disabled:cursor-not-allowed",value:u.subtitle||"",placeholder:"日期 | 天數 | 旅行人數",onChange:$=>pt({...u,subtitle:$.target.value}),disabled:t==null?void 0:t.isAnonymous})]}),P.jsxs("div",{className:"flex gap-3",children:[P.jsx("button",{onClick:()=>S(!0),title:"加入行程",children:P.jsx(kg,{size:20,className:"text-gray-500 hover:text-white"})}),P.jsx("button",{onClick:()=>j(!0),title:"手機 QR Code",children:P.jsx(rP,{size:20,className:"text-gray-500 hover:text-white"})}),P.jsx("button",{onClick:J,title:"分享連結/代碼",children:P.jsx(ew,{size:20,className:"text-yellow-500 hover:text-yellow-400"})})]})]}),P.jsxs("div",{className:"flex flex-wrap gap-2 mb-4",children:[(u.tags||[]).map(($,Z)=>P.jsx("span",{className:"px-3 py-1 bg-orange-500/20 text-orange-400 text-xs rounded-full font-medium border border-orange-500/20",children:$},Z)),!(t!=null&&t.isAnonymous)&&P.jsx("button",{className:"px-2 py-1 text-gray-600 text-xs border border-gray-800 rounded-full hover:border-gray-600",children:"+"})]}),P.jsxs("div",{className:"absolute top-4 right-4 flex items-center gap-1 text-xs",children:[m==="saving"&&P.jsxs("span",{className:"text-yellow-500 flex items-center animate-pulse",children:[P.jsx(Pg,{size:12,className:"mr-1"})," 儲存中..."]}),m==="saved"&&P.jsxs("span",{className:"text-green-500 flex items-center",children:[P.jsx(eP,{size:12,className:"mr-1"})," 已同步"]}),m==="error"&&P.jsxs("span",{className:"text-red-500 flex items-center",children:[P.jsx(ZC,{size:12,className:"mr-1"})," ",t!=null&&t.isAnonymous?"訪客模式":"未同步"]})]}),P.jsxs("div",{className:"bg-[#1c1c1e] rounded-xl p-4 mb-4 border border-gray-800 flex items-center relative overflow-hidden group",children:[P.jsx("div",{className:"absolute left-0 top-0 bottom-0 w-1 bg-blue-500"}),P.jsx("div",{className:"mr-4 text-blue-400",children:P.jsx(Rg,{size:24})}),P.jsxs("div",{className:"flex-1 grid grid-cols-2 gap-4",children:[P.jsxs("div",{children:[P.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:["去程 (",((xt=(Pt=u.flight)==null?void 0:Pt.outbound)==null?void 0:xt.date)||"Date",")"]}),P.jsx("div",{className:"text-sm text-gray-300 font-mono",children:((Mo=(Nt=u.flight)==null?void 0:Nt.outbound)==null?void 0:Mo.code)||"Flight"}),P.jsx("div",{className:"text-xs text-gray-400",children:((yr=(Lo=u.flight)==null?void 0:Lo.outbound)==null?void 0:yr.route)||"Origin -> Dest"})]}),P.jsxs("div",{children:[P.jsxs("div",{className:"text-xs text-gray-500 mb-1",children:["回程 (",((Qr=(vr=u.flight)==null?void 0:vr.inbound)==null?void 0:Qr.date)||"Date",")"]}),P.jsx("div",{className:"text-sm text-gray-300 font-mono",children:((Yr=(Xr=u.flight)==null?void 0:Xr.inbound)==null?void 0:Yr.code)||"Flight"}),P.jsx("div",{className:"text-xs text-gray-400",children:((es=(Jr=u.flight)==null?void 0:Jr.inbound)==null?void 0:es.route)||"Origin -> Dest"})]})]})]}),P.jsxs("div",{className:"flex overflow-x-auto no-scrollbar border-b border-gray-800",children:[(u.days||[]).map(($,Z)=>{const le=re&&re.id===$.id;return P.jsxs("button",{onClick:()=>g($.id),className:`flex-shrink-0 px-4 py-3 text-sm font-medium transition-all border-b-2 relative ${le?"text-yellow-500 border-yellow-500":"text-gray-500 border-transparent hover:text-gray-300"}`,children:["Day ",Z+1]},$.id)}),!(t!=null&&t.isAnonymous)&&P.jsx("button",{onClick:K,className:"px-4 py-3 text-gray-600 hover:text-yellow-500",children:P.jsx(Cg,{size:16})})]})]})}),o&&P.jsxs("div",{className:"bg-red-900/90 text-white px-4 py-3 text-sm flex items-center justify-center gap-2 border-b border-red-500 sticky top-0 z-50 animate-pulse",children:[P.jsx(oP,{size:16,className:"text-yellow-300"}),P.jsx("span",{children:o})]}),P.jsx("div",{className:"max-w-md mx-auto px-5 py-4",children:P.jsxs("div",{className:"space-y-0 relative",children:[P.jsxs("div",{className:"flex items-center gap-2 mb-4 text-gray-400 text-sm",children:[P.jsx(JC,{size:16})," ",P.jsx("span",{children:"每日行程時間軸"})]}),re&&(re.activities||[]).map(($,Z)=>P.jsxs("div",{className:"relative pl-0 group flex",children:[P.jsx("div",{className:"w-14 pt-1 pr-2 flex-shrink-0 text-right",children:P.jsx("input",{type:"time",value:$.time,onChange:le=>jt(re.id,$.id,"time",le.target.value),disabled:t==null?void 0:t.isAnonymous,className:"text-sm font-bold text-gray-300 bg-transparent w-full text-right outline-none focus:text-yellow-500 font-mono disabled:opacity-50 disabled:cursor-not-allowed"})}),P.jsxs("div",{className:"relative flex flex-col items-center mr-4",children:[P.jsx("div",{className:`absolute w-[2px] bg-[#333] ${Z===0?"top-3 h-[calc(100%-12px)]":"h-full"} ${Z===re.activities.length-1?"h-4":""}`}),P.jsx("div",{className:`relative z-10 w-8 h-8 rounded-full border-2 flex items-center justify-center transition-transform hover:scale-110 ${ue($.type)}`,children:ge($.type)})]}),P.jsx("div",{className:"flex-1 pb-8 min-w-0",children:P.jsxs("div",{className:"flex justify-between items-start group-hover:bg-[#1c1c1e] p-2 -mt-2 -ml-2 rounded-lg transition-colors",children:[P.jsxs("div",{className:"flex-1",children:[P.jsx("input",{value:$.title,placeholder:"行程標題",onChange:le=>jt(re.id,$.id,"title",le.target.value),disabled:t==null?void 0:t.isAnonymous,className:"w-full text-base font-bold text-gray-200 bg-transparent outline-none placeholder-gray-700 disabled:opacity-70 disabled:cursor-not-allowed"}),P.jsxs("div",{className:"flex flex-col mt-0.5",children:[P.jsx("input",{value:$.subtitle||"",placeholder:"備註 / 航班號 / 費用",onChange:le=>jt(re.id,$.id,"subtitle",le.target.value),disabled:t==null?void 0:t.isAnonymous,className:"text-xs text-gray-500 bg-transparent outline-none placeholder-gray-800 disabled:opacity-70 disabled:cursor-not-allowed"}),P.jsxs("div",{className:"flex items-center mt-1",children:[P.jsx("input",{value:$.location,placeholder:"地點...",onChange:le=>jt(re.id,$.id,"location",le.target.value),disabled:t==null?void 0:t.isAnonymous,className:"text-xs text-gray-500 bg-transparent outline-none placeholder-gray-800 min-w-0 disabled:opacity-70 disabled:cursor-not-allowed"}),$.location&&P.jsx("a",{href:`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent($.location)}`,target:"_blank",rel:"noopener noreferrer",className:"ml-2 text-yellow-600 hover:text-yellow-500",children:P.jsx(lc,{size:12})})]})]})]}),!(t!=null&&t.isAnonymous)&&P.jsxs("div",{className:"opacity-0 group-hover:opacity-100 transition-opacity flex flex-col gap-2 ml-2",children:[P.jsxs("select",{value:$.type,onChange:le=>jt(re.id,$.id,"type",le.target.value),className:"bg-gray-800 text-xs text-gray-400 rounded px-1 py-0.5 outline-none border border-gray-700",children:[P.jsx("option",{value:"plane",children:"飛機"}),P.jsx("option",{value:"car",children:"汽車"}),P.jsx("option",{value:"transport",children:"交通"}),P.jsx("option",{value:"food",children:"餐廳"}),P.jsx("option",{value:"stay",children:"住宿"}),P.jsx("option",{value:"sightseeing",children:"景點"}),P.jsx("option",{value:"camera",children:"拍照"})]}),P.jsx("button",{onClick:()=>z(re.id,$.id),className:"text-gray-600 hover:text-red-500 self-end",children:P.jsx(sP,{size:14})})]})]})})]},$.id)),re&&P.jsxs("div",{className:"pl-14 flex items-center gap-4",children:[P.jsx("div",{className:"w-8 flex justify-center",children:P.jsx("div",{className:"w-[2px] h-4 bg-[#333]"})}),!(t!=null&&t.isAnonymous)&&P.jsxs("button",{onClick:()=>_(!0),className:"flex items-center gap-2 text-gray-500 hover:text-yellow-500 text-sm py-2",children:[P.jsx("div",{className:"w-6 h-6 rounded-full border border-dashed border-gray-600 flex items-center justify-center",children:P.jsx(Cg,{size:14})}),"新增行程"]})]})]})}),P.jsxs("div",{className:`fixed bottom-6 left-1/2 -translate-x-1/2 bg-yellow-500 text-black px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2 transition-all ${x?"opacity-100 translate-y-0":"opacity-0 translate-y-4 pointer-events-none"}`,children:[P.jsx(XC,{size:16})," ",O]})]})}Hv(document.getElementById("root")).render(P.jsx(de.StrictMode,{children:P.jsx(vP,{})}));
